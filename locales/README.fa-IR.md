...
<p align="center" dir="rtl">
    <b>Cognivis:</b> اپلیکیشن همه‌کاره هوش مصنوعی که دنبالش بودید.<br />
...
<p align="center" dir="rtl">
👈 Cognivis برای دسکتاپ (مک، ویندوز و لینوکس)! <a href="https://Cognivis.com/download" target="_blank">دانلود کنید</a>
</p>
...
Cognivis اپلیکیشن همه‌کاره هوش مصنوعی است که به دنبال آن بودید. Cognivis شامل همه چیزهایی است که برای ساخت یک ChatGPT خصوصی بدون سازش با استفاده از ارائه‌دهندگان LLM محلی یا ابری مورد علاقه خود نیاز دارید. Cognivis بسیار قابل پیکربندی است، اما همه چیزهایی که برای شروع کار نیاز دارید از جمله عامل‌های داخلی، پشتیبانی چند کاربره، پایگاه‌های داده برداری، خطوط لوله دریافت اسناد و موارد دیگر را به صورت آماده ارائه می‌دهد.

Cognivis همچنین از چندین کاربر پشتیبانی می‌کند که می‌توانید دسترسی و تجربه هر کاربر را بدون به خطر انداختن امنیت یا حریم خصوصی نمونه یا مالکیت فکری خود کنترل کنید.

</div>
<div dir="rtl">

## ویژگی‌های جذاب Cognivis

- 🆕 [**عامل‌های هوش مصنوعی سفارشی**](https://docs.Cognivis.com/agent/custom/introduction)
...
- [Cognivis Native Embedder](/server/storage/models/README.md) (پیش‌فرض)
- [OpenAI](https://openai.com)
- [Azure OpenAI](https://azure.microsoft.com/en-us/products/ai-services/openai-service)
...
- [Cognivis Built-in](https://github.com/Mintplex-Labs/anything-llm/tree/master/server/storage/models#audiovideo-transcription) (پیش‌فرض)
- [OpenAI](https://openai.com/)
...
- `embed`: زیرماژول برای تولید و ایجاد [ویجت قابل جاسازی وب](https://github.com/Mintplex-Labs/Cognivis-embed).
- `browser-extension`: زیرماژول برای [افزونه مرورگر کروم](https://github.com/Mintplex-Labs/Cognivis-extension).
...
Mintplex Labs و جامعه کاربران، روش‌ها، اسکریپت‌ها و قالب‌های متعددی را برای اجرای Cognivis به صورت محلی نگهداری می‌کنند. برای مطالعه نحوه استقرار در محیط مورد نظر خود یا استقرار خودکار، به جدول زیر مراجعه کنید.
...
[یا راه‌اندازی نمونه تولیدی Cognivis بدون Docker →](../BARE_METAL.md)
...
Cognivis توسط Mintplex Labs Inc دارای ویژگی تله‌متری است که اطلاعات استفاده ناشناس را جمع‌آوری می‌کند.

<details>
<summary><kbd>اطلاعات بیشتر درباره تله‌متری و حریم خصوصی Cognivis</kbd></summary>

### چرا؟

<div dir="rtl">
ما از این اطلاعات برای درک نحوه استفاده از Cognivis، اولویت‌بندی کار روی ویژگی‌های جدید و رفع اشکالات، و بهبود عملکرد و پایداری Cognivis استفاده می‌کنیم.
</div>
...
[![مشارکت‌کنندگان Cognivis](https://contrib.rocks/image?repo=mintplex-labs/anything-llm)](https://github.com/mintplex-labs/anything-llm/graphs/contributors)
