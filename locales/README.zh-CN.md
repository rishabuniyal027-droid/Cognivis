...
<p align="center">
    <b>Cognivis：</b> 您一直在寻找的全方位AI应用程序。<br />
...
<p align="center">
👉 适用于桌面（Mac、Windows和Linux）的Cognivis！<a href="https://Cognivis.com/download" target="_blank">立即下载</a>
</p>
...
Cognivis是您一直在寻找的全方位AI应用程序。Cognivis包含了使用您喜爱的本地或云端LLM提供商构建私有ChatGPT所需的一切，毫无妥协。Cognivis高度可配置，但开箱即用，内置代理、多用户支持、向量数据库、文档摄取管道等功能。

Cognivis还支持多用户，您可以控制每个用户的访问权限和体验，同时不会影响实例的安全性、隐私性或您的知识产权。

## Cognivis的一些酷炫特性

- 🆕 [**完全兼容 MCP**](https://docs.Cognivis.com/mcp-compatibility/overview)
- 🆕 [**无代码AI代理构建器**](https://docs.Cognivis.com/agent-flows/overview)
- 🖼️ **多用户实例支持和权限管理（支持封闭源和开源LLM！）**
- [**自定义人工智能代理**](https://docs.Cognivis.com/agent/custom/introduction)
- 👤 多用户实例支持和权限管理 _仅限Docker版本_
- 🦾 工作区内的智能体（浏览网页、运行代码等）
- 💬 [为您的网站定制的可嵌入聊天窗口](https://github.com/Mintplex-Labs/Cognivis-embed/blob/main/README.md)
...
- [Cognivis原生嵌入器](/server/storage/models/README.md)（默认）
- [OpenAI](https://openai.com)
- [Azure OpenAI](https://azure.microsoft.com/en-us/products/ai-services/openai-service)
...
- [Cognivis内置](https://github.com/Mintplex-Labs/anything-llm/tree/master/server/storage/models#audiovideo-transcription) （默认）
- [OpenAI](https://openai.com/)
...
- `embed`: 用于生成和创建[网页嵌入组件](https://github.com/Mintplex-Labs/Cognivis-embed)的子模块.
- `browser-extension`: 用于[Chrome 浏览器扩展](https://github.com/Mintplex-Labs/Cognivis-extension)的子模块.

## 🛳 自托管

Mintplex Labs和社区维护了许多部署方法、脚本和模板，您可以使用它们在本地运行Cognivis。请参阅下面的表格，了解如何在您喜欢的环境上部署，或自动部署。
...
[其他方案：不使用Docker配置Cognivis实例 →](../BARE_METAL.md)
...
由 Mintplex Labs Inc 开发的 Cognivis 包含一个收集匿名使用信息的 Telemetry 功能。

<details>
<summary><kbd>有关 Cognivis 的远程信息收集与隐私保护更多信息</kbd></summary>

### 为什么收集信息？

我们使用这些信息来帮助我们理解 Cognivis 的使用情况，帮助我们确定新功能和错误修复的优先级，并帮助我们提高 Cognivis 的性能和稳定性。
...
[![Cognivis 的贡献者们](https://contrib.rocks/image?repo=mintplex-labs/anything-llm)](https://github.com/mintplex-labs/anything-llm/graphs/contributors)
