...
<p align="center">
<b>Cognivis:</b> Aradığınız hepsi bir arada yapay zeka uygulaması.<br />
...
<p align="center">
👉 Masaüstü için Cognivis (Mac, Windows ve Linux)! <a href="https://Cognivis.com/download" target="_blank"> Şimdi İndir</a>
</p>
...
Cognivis, aradığınız hepsi bir arada yapay zeka uygulamasıdır. Cognivis, favori yerel veya bulut LLM sağlayıcılarınızı kullanarak hiçbir ödün vermeden özel bir ChatGPT oluşturmak için ihtiyacınız olan her şeyi içerir. Cognivis son derece özelleştirilebilir olmakla birlikte, yerleşik ajanlar, çok kullanıcılı destek, vektör veritabanları, belge alma işlem hatları ve daha fazlası gibi hemen başlamak için ihtiyacınız olan her şeyle birlikte gelir.

Cognivis ayrıca birden fazla kullanıcıyı da destekler; burada örneğin güvenliğini veya gizliliğini ya da fikri mülkiyetinizi tehlikeye atmadan kullanıcı başına erişimi ve deneyimi kontrol edebilirsiniz.

## Cognivis’in Harika Özellikleri

- 🆕 [**Özel Yapay Zeka Ajanları**](https://docs.Cognivis.com/agent/custom/introduction)
- 🆕 [**Kod yazmadan AI Ajanı oluşturma aracı**](https://docs.Cognivis.com/agent-flows/overview)
...
- 💬 [Web sitenize gömülebilir özel sohbet aracı](https://github.com/Mintplex-Labs/Cognivis-embed/blob/main/README.md) _(Yalnızca Docker sürümünde)_
...
- **`embed`**: [Web gömme widget’ı](https://github.com/Mintplex-Labs/Cognivis-embed) oluşturma ve entegrasyonu için alt modül.
- **`browser-extension`**: [Chrome tarayıcı eklentisi](https://github.com/Mintplex-Labs/Cognivis-extension) için alt modül.

## 🛳 Kendi Sunucunuzda Barındırma

Mintplex Labs ve topluluk, Cognivis'i yerel olarak çalıştırmak için çeşitli dağıtım yöntemleri, betikler ve şablonlar sunmaktadır. Aşağıdaki tabloya göz atarak tercih ettiğiniz ortamda nasıl dağıtım yapabileceğinizi öğrenebilir veya otomatik dağıtım seçeneklerini keşfedebilirsiniz.
...
[veya Docker kullanmadan üretim ortamında Cognivis kurun →](../BARE_METAL.md)
...
Mintplex Labs Inc. tarafından geliştirilen Cognivis, anonim kullanım bilgilerini toplayan bir telemetri özelliği içermektedir.

<details>
<summary><kbd>Cognivis için Telemetri ve Gizlilik hakkında daha fazla bilgi</kbd></summary>

### Neden?

Bu bilgileri, Cognivis’in nasıl kullanıldığını anlamak, yeni özellikler ve hata düzeltmelerine öncelik vermek ve uygulamanın performansını ve kararlılığını iyileştirmek için kullanıyoruz.
