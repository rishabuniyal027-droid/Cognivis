...
const exportOptions = {
  csv: {
    ...
    fileExtension: "csv",
    filenameFunc: () => {
      return `Cognivis-chats-${new Date().toLocaleDateString()}`;
    },
  },
  json: {
    name: "JSON",
  ...
  jsonl: {
    ...
    fileExtension: "jsonl",
    filenameFunc: () => {
      return `Cognivis-chats-${new Date().toLocaleDateString()}-lines`;
    },
  },
  jsonAlpaca: {
    name: "JSON (Alpaca)",
    ...
    fileExtension: "json",
    filenameFunc: () => {
      return `Cognivis-chats-${new Date().toLocaleDateString()}-alpaca`;
    },
  },
};
