...
https://github.com/Mintplex-Labs/Cognivis-embed/blob/main/README.md
-->
<script
  data-embed-id="${embed.uuid}"
  data-base-api-url="${serverHost}/api/embed"
  src="${scriptHost}/embed/Cognivis-chat-widget.min.js">
</script>
<!-- Cognivis (https://Cognivis.com) -->
`;
}
  ...
  return (
    <div>
      <div className="flex flex-col mb-2">
        ...
        <a
          href="https://github.com/Mintplex-Labs/Cognivis-embed/blob/main/README.md"
          target="_blank"
          rel="noreferrer"
