...
export default {
  ...
  docs: (path = "") => {
    return `https://docs.Cognivis.com${path}`;
  },
  chatModes: () => {
    return "https://docs.Cognivis.com/features/chat-modes";
  },
  mailToMintplex: () => {
    return "mailto:team@mintplexlabs.com";
  },
  hosting: () => {
    return "https://my.mintplexlabs.com/aio-checkout?product=Cognivis";
  },
  workspace: {
    chat: (slug, options = {}) => {
  ...
  communityHub: {
    ...
    noPrivateItems: () => {
      return "https://docs.Cognivis.com/community-hub/faq#no-private-items";
    },
  },

  // TODO: Migrate all docs.Cognivis.com links to the new docs.
  documentation: {
    mobileIntroduction: () => {
      return "https://docs.Cognivis.com/mobile/overview";
    },
    contextWindows: () => {
      return "https://docs.Cognivis.com/chatting-with-documents/introduction#you-exceed-the-context-window---what-now";
    },
  },
