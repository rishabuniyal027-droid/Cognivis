...
const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      ...
      description:
        "Cognivis poate funcționa cu mai mulți furnizori LLM. Acesta va fi serviciul care gestionează conversațiile.",
    },
    userSetup: {
    ...
    survey: {
      title: "Bun venit la Cognivis",
      description:
        "Ajută-ne să facem Cognivis potrivit pentru nevoile tale. Opțional.",
      email: "Care este adresa ta de email?",
      useCase: "Pentru ce vei folosi Cognivis?",
      useCaseWork: "Pentru muncă",
      useCasePersonal: "Pentru uz personal",
      useCaseOther: "Altele",
      comment: "De unde ai aflat despre Cognivis?",
      commentPlaceholder:
  ...
  vector: {
    ...
    description:
      "Acestea sunt credențialele și setările pentru modul în care funcționează instanța ta Cognivis. Este important să fie corecte și actuale.",
    provider: {
  ...
  privacy: {
    ...
    description:
      "Aceasta este configurația ta pentru modul în care furnizorii terți conectați și Cognivis gestionează datele tale.",
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "Aceste fișiere vor fi încărcate în procesorul de documente care rulează pe această instanță Cognivis. Aceste fișiere nu sunt trimise sau partajate cu o terță parte.",
    },
    pinning: {
      what_pinning: "Ce este fixarea documentelor?",
      pin_explained_block1:
        "Când **fixezi** un document în Cognivis, vom injecta întregul conținut al documentului în fereastra de prompt pentru ca LLM-ul tău să-l înțeleagă pe deplin.",
      ...
      pin_explained_block3:
        "Dacă nu obții răspunsurile dorite de la Cognivis în mod implicit, atunci fixarea este o modalitate excelentă de a obține răspunsuri de calitate superioară dintr-un clic.",
      accept: "Ok, am înțeles",
    },
    watching: {
      what_watching: "Ce face vizualizarea unui document?",
      watch_explained_block1:
        "Când **urmărești** un document în Cognivis, vom sincroniza *automat* conținutul documentului tău din sursa originală la intervale regulate. Acest lucru va actualiza automat conținutul în fiecare spațiu de lucru unde acest fișier este gestionat.",
  ...
  chat_window: {
    ...
    memories: {
      ...
      modal: {
        ...
        label: "Memorie",
        placeholder:
          "De exemplu, numele utilizatorului este Joe, utilizatorul lucrează cu Cognivis, etc.",
        create: "Creați",
        save: "Salvați",
        cancel: "Anula",
      },
    ...
    publish: {
      ...
      generic: {
        unauthenticated: {
          ...
          description:
            "Trebuie să te autentifici cu Cognivis Community Hub înainte de a publica elemente.",
  ...
  agent: {
    ...
    settings: {
      ...
      "intelligent-skill-selection": {
        ...
        "beta-badge": "Beta",
        description:
          "Permite utilizarea nelimitată a instrumentelor și reduce utilizarea token-urilor cu până la 80% pentru fiecare interogare – Cognivis selectează automat abilitățile potrivite pentru fiecare solicitare.",
        "max-tools": {
          title: "Max Tools",
          description:
  ...
  customization: {
    interface: {
      title: "Preferințe UI",
      description: "Setează preferințele UI pentru Cognivis.",
    },
    branding: {
      title: "Branding & White-labeling",
      description:
        "Personalizează-ți instanța Cognivis cu branding personalizat.",
    },
    chat: {
      title: "Chat",
      description: "Setează preferințele de chat pentru Cognivis.",
      auto_submit: {
    ...
    items: {
      ...
      "display-language": {
        ...
        description:
          "Selectează limba preferată pentru a reda interfața Cognivis - atunci când traducerile sunt disponibile.",
      },
      logo: {
        title: "Logo brand",
        description:
  ...
  api: {
    title: "Chei API",
    description:
      "Cheile API permit deținătorului să acceseze și să gestioneze programatic această instanță Cognivis.",
    ...
    modal: {
      ...
      helper:
        "După creare, cheia API poate fi folosită pentru a accesa și configura programatic această instanță Cognivis.",
      name: {
        label: "Nume",
  ...
  llm: {
    title: "Preferința LLM",
    description:
      "Acestea sunt credențialele și setările pentru furnizorul tău preferat de chat și embedding LLM. Este important ca aceste chei să fie actuale și corecte, altfel Cognivis nu va funcționa corect.",
  ...
  transcription: {
    ...
    "warn-start":
      "Utilizarea modelului local Whisper pe mașini cu RAM sau CPU limitat poate bloca Cognivis la procesarea fișierelor media.",
    "warn-recommend":
  ...
  embedding: {
    ...
    "desc-end":
      "Embedding-ul este procesul de transformare a textului în vectori. Aceste credențiale sunt necesare pentru a transforma fișierele și prompturile dvs. într-un format pe care Cognivis îl poate utiliza pentru procesare.",
    provider: {
  ...
  security: {
    ...
    password: {
      ...
      description:
        "Protejează instanța Cognivis cu o parolă. Dacă o uiți, nu există metode de recuperare, deci asigură-te că o salvezi.",
  ...
  telegram: {
    ...
    description:
      "Conectați instanța dumneavoastră Cognivis cu Telegram, astfel încât să puteți interacționa cu spațiile de lucru de pe orice dispozitiv.",
    setup: {
      step1: {
