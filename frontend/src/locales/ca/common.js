...
const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      ...
      description:
        "Cognivis pot treballar amb molts proveïdors de LLM. Aquest serà el servei que gestionarà les converses.",
    },
    userSetup: {
    ...
    survey: {
      title: "Benvingut a Cognivis",
      description:
        "Ajuda'ns a fer que Cognivis s'adapti a les teves necessitats. Opcional.",
      email: "Quin és el teu correu electrònic?",
      useCase: "Per a què faràs servir Cognivis?",
      useCaseWork: "Per a la feina",
      useCasePersonal: "Per a ús personal",
      useCaseOther: "Altres",
      comment: "Com has sabut d'Cognivis?",
      commentPlaceholder:
  ...
  agent: {
    ...
    settings: {
      ...
      "intelligent-skill-selection": {
        ...
        "beta-badge": "Beta",
        description:
          "Activa eines il·limitades i redueix l'ús de tokens fins a un 80% per consulta: Cognivis selecciona automàticament les habilitats adequades per a cada missatge.",
        "max-tools": {
          title: "Màxim d'eines",
          description:
  ...
  customization: {
    interface: {
      ...
      description:
        "Estableix les teves preferències d'interfície per a Cognivis.",
    },
    branding: {
      title: "Marca i etiqueta blanca",
      description:
        "Personalitza la teva instància d'Cognivis amb una marca pròpia.",
    },
    chat: {
      title: "Xat",
      description: "Estableix les teves preferències de xat per a Cognivis.",
      auto_submit: {
    ...
    items: {
      ...
      "display-language": {
        ...
        description:
          "Selecciona l'idioma preferit per mostrar la interfície d'Cognivis, quan les traduccions estiguin disponibles.",
      },
      logo: {
  ...
  api: {
    title: "Claus API",
    description:
      "Les claus API permeten al titular accedir i gestionar programàticament aquesta instància d'Cognivis.",
    ...
    modal: {
      ...
      helper:
        "Un cop creada, la clau API es pot usar per accedir i configurar programàticament aquesta instància d'Cognivis.",
      name: {
        label: "Nom",
  ...
  llm: {
    title: "Preferència de LLM",
    description:
      "Aquestes són les credencials i la configuració del teu proveïdor preferit de xat i embedding de LLM. És important que aquestes claus siguin actuals i correctes, o bé Cognivis no funcionarà correctament.",
  ...
  transcription: {
    ...
    "warn-start":
      "L'ús del model whisper local en màquines amb poca RAM o CPU pot bloquejar Cognivis en processar fitxers multimèdia.",
    "warn-recommend":
  ...
  embedding: {
    ...
    "desc-end":
      "L'embedding és el procés de convertir text en vectors. Aquestes credencials són necessàries per convertir els teus fitxers i missatges en un format que Cognivis pugui processar.",
    provider: {
  ...
  vector: {
    ...
    description:
      "Aquestes són les credencials i la configuració de com funcionarà la teva instància d'Cognivis. És important que aquestes claus siguin actuals i correctes.",
    provider: {
  ...
  telegram: {
    ...
    description:
      "Connecta la teva instància d'Cognivis a Telegram per poder xatejar amb els teus espais de treball des de qualsevol dispositiu.",
    setup: {
      step1: {
  ...
  security: {
    ...
    password: {
      ...
      description:
        "Protegeix la teva instància d'Cognivis amb una contrasenya. Si l'oblides, no hi ha cap mètode de recuperació, per la qual cosa assegura't de guardar-la.",
  ...
  privacy: {
    ...
    description:
      "Aquesta és la teva configuració de com els proveïdors de tercers connectats i Cognivis gestionen les teves dades.",
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "Aquests fitxers es pujaran al processador de documents que s'executa en aquesta instància d'Cognivis. Aquests fitxers no s'envien ni es comparteixen amb tercers.",
    },
    pinning: {
      what_pinning: "Què és l'ancoratge de documents?",
      pin_explained_block1:
        "Quan <b>ancore</b>s un document a Cognivis, injectarem tot el contingut del document a la teva finestra de missatge perquè el teu LLM el comprengui completament.",
      ...
      pin_explained_block3:
        "Si per defecte no obtens les respostes que desitges d'Cognivis, l'ancoratge és una manera excel·lent d'obtenir respostes de major qualitat amb un sol clic.",
      accept: "D'acord, entès",
    },
    watching: {
      what_watching: "Què fa observar un document?",
      watch_explained_block1:
        "Quan <b>observes</b> un document a Cognivis, sincronitzarem <i>automàticament</i> el contingut del document des de la seva font original a intervals regulars. Això actualitzarà automàticament el contingut a cada espai de treball on es gestioni aquest fitxer.",
    ...
    publish: {
      ...
      generic: {
        unauthenticated: {
          ...
          description:
            "Has d'autenticar-te amb el Centre de la comunitat d'Cognivis abans de publicar elements.",
