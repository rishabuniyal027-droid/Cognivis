...
const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      ...
      description:
        "Cognivis funciona com vários provedores de LLM. Este será o serviço que lidará com os chats.",
    },
    userSetup: {
    ...
    survey: {
      title: "Bem-vindo ao Cognivis",
      description: "Ajude-nos a melhorar o Cognivis. Opcional.",
      email: "Qual seu email?",
      useCase: "Como você usará o Cognivis?",
      useCaseWork: "Para trabalho",
      useCasePersonal: "Uso pessoal",
      useCaseOther: "Outro",
      comment: "Como você conheceu o Cognivis?",
      commentPlaceholder:
  ...
  general: {
    ...
    message: {
      ...
      body: "os benefícios do Cognivis",
    },
    delete: {
  ...
  agent: {
    ...
    settings: {
      ...
      "intelligent-skill-selection": {
        ...
        "beta-badge": "Beta",
        description:
          "Permita o uso ilimitado de ferramentas e reduza o consumo de tokens em até 80% por consulta — O Cognivis seleciona automaticamente as habilidades mais adequadas para cada solicitação.",
        "max-tools": {
  ...
  customization: {
    ...
    branding: {
      ...
      description: "Personalize sua instância do Cognivis com sua marca.",
    },
    chat: {
      title: "Chat",
  ...
  api: {
    ...
    modal: {
      ...
      helper:
        "Depois de criada, a chave de API pode ser usada para acessar e configurar esta instância do Cognivis programaticamente.",
      name: {
        label: "Nome",
  ...
  transcription: {
    ...
    "warn-start":
      "Usar o modelo local whisper em máquinas com RAM ou CPU limitada pode travar o Cognivis.",
  ...
  privacy: {
    ...
    description:
      "Configurações de como provedores terceiros e o Cognivis lidam com seus dados.",
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "Esses arquivos são enviados ao processador local do Cognivis. Não são compartilhados com terceiros.",
    },
    pinning: {
  ...
  chat_window: {
    ...
    memories: {
      ...
      modal: {
        ...
        label: "Memória",
        placeholder:
          "por exemplo, o nome do usuário é Joe, o usuário trabalha com Cognivis, etc.",
        create: "Criar",
        save: "Salvar",
        cancel: "Cancelar",
      },
  ...
  telegram: {
    ...
    description:
      "Conecte sua instância do Cognivis ao Telegram para que possa conversar com seus espaços de trabalho a partir de qualquer dispositivo.",
    setup: {
      step1: {
