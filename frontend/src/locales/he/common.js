...
const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      ...
      description:
        "Cognivis יכול לעבוד עם ספקי מודלי שפה (LLM) רבים. זה יהיה השירות שיטפל בצ'אט.",
    },
    userSetup: {
      title: "הגדרת משתמש",
    ...
    survey: {
      title: "ברוכים הבאים ל-Cognivis",
      description:
        "עזרו לנו לבנות את Cognivis כך שיתאים לצרכים שלכם. אופציונלי.",
      email: "מה האימייל שלך?",
      useCase: "לאיזו מטרה תשתמש ב-Cognivis?",
      useCaseWork: "לעבודה",
      useCasePersonal: "לשימוש אישי",
      useCaseOther: "אחר",
      comment: "איך שמעת על Cognivis?",
      commentPlaceholder:
  ...
  agent: {
    ...
    settings: {
      ...
      "intelligent-skill-selection": {
        ...
        "beta-badge": "בטא",
        description:
          "אפשרו שימוש בלתי מוגבל בכלים וצמצום השימוש בטוקנים עד 80% לכל שאילתה – ה-Cognivis בוחר באופן אוטומטי את הכישורים המתאימים ביותר לכל בקשה.",
        "max-tools": {
          title: "כלים של מקס",
          description:
  ...
  customization: {
    interface: {
      ...
      description: "הגדר את העדפות ממשק המשתמש שלך עבור Cognivis.",
    },
    branding: {
      title: "מיתוג והתאמה אישית (Whitelabeling)",
      description: "התאם אישית את מופע ה-Cognivis שלך עם מיתוג מותאם אישית.",
    },
    chat: {
      title: "צ'אט",
      description: "הגדר את העדפות הצ'אט שלך עבור Cognivis.",
      auto_submit: {
    ...
    items: {
      ...
      "display-language": {
        title: "שפת תצוגה",
        description:
          "בחר את השפה המועדפת להצגת ממשק המשתמש של Cognivis - כאשר תרגומים זמינים.",
      },
      logo: {
        title: "לוגו מותג",
  ...
  api: {
    title: "מפתחות API",
    description:
      "מפתחות API מאפשרים למחזיק בהם לגשת ולנהל באופן תכנותי את מופע Cognivis זה.",
    ...
    modal: {
      ...
      create: "צור מפתח API",
      helper:
        "לאחר יצירתו, ניתן להשתמש במפתח ה-API כדי לגשת למופע Cognivis זה ולהגדיר אותו באופן תכנותי.",
      name: {
        label: "שם",
  ...
  llm: {
    title: "העדפות מודל שפה (LLM)",
    description:
      "אלה האישורים וההגדרות עבור ספק הצ'אט וההטמעה המועדף עליך. חשוב שמפתחות אלה יהיו עדכניים ונכונים, אחרת Cognivis לא יפעל כראוי.",
    provider: "ספק LLM",
    providers: {
      azure_openai: {
  ...
  transcription: {
    ...
    provider: "ספק תמלול",
    "warn-start":
      "שימוש במודל ה-whisper המקומי על מכונות עם זיכרון RAM או מעבד מוגבלים עלול לגרום להאטה של Cognivis בעת עיבוד קובצי מדיה.",
    "warn-recommend":
  ...
  embedding: {
    ...
    "desc-end":
      "הטמעה היא תהליך של הפיכת טקסט לווקטורים. אישורים אלה נדרשים כדי להפוך את הקבצים וההנחיות שלך לפורמט ש-Cognivis יכול להשתמש בו לעיבוד.",
    provider: {
      title: "ספק הטמעה",
    },
  },
  ...
  vector: {
    ...
    description:
      "אלה האישורים וההגדרות לאופן פעולת מופע ה-Cognivis שלך. חשוב שמפתחות אלה יהיו עדכניים ונכונים.",
    provider: {
  ...
  privacy: {
    ...
    description:
      "זוהי התצורה שלך לאופן שבו ספקים צד שלישי מחוברים ו-Cognivis מטפלים בנתונים שלך.",
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "קבצים אלה יועלו למעבד המסמכים הפועל במופע זה של Cognivis. קבצים אלה אינם נשלחים או משותפים עם צד שלישי.",
    },
    pinning: {
      what_pinning: "מהי הצמדת מסמכים?",
      pin_explained_block1:
        "כאשר אתה <b>מצמיד</b> מסמך ב-Cognivis, אנו נזריק את כל תוכן המסמך לחלון ההנחיה שלך כדי שמודל השפה שלך יבין אותו במלואו.",
      pin_explained_block2:
        "זה עובד בצורה הטובה ביותר עם <b>מודלים בעלי הקשר רחב</b> או קבצים קטנים שהם קריטיים לבסיס הידע שלו.",
      pin_explained_block3:
        "אם אינך מקבל את התשובות הרצויות מ-Cognivis כברירת מחדל, הצמדה היא דרך מצוינת לקבל תשובות איכותיות יותר בלחיצה אחת.",
      accept: "אוקיי, הבנתי",
    },
    watching: {
      what_watching: "מה עושה מעקב אחר מסמך?",
      watch_explained_block1:
        "כאשר אתה <b>עוקב</b> אחר מסמך ב-Cognivis, אנו נסנכרן <i>אוטומטית</i> את תוכן המסמך שלך ממקורו המקורי במרווחי זמן קבועים. זה יעדכן אוטומטית את התוכן בכל סביבת עבודה שבה קובץ זה מנוהל.",
  ...
  chat_window: {
    ...
    memories: {
      ...
      modal: {
        ...
        label: "זיכרון",
        placeholder:
          "לדוגמה, שם המשתמש הוא ג'ואי, המשתמש עובד על פלטפורמת Cognivis, וכן הלאה.",
        create: "צור",
        save: "שמור",
        cancel: "בטל",
      },
    ...
    publish: {
      ...
      generic: {
        unauthenticated: {
          title: "נדרש אימות",
          description:
            "עליך להתאמת עם מרכז הקהילה של Cognivis לפני פרסום פריטים.",
  ...
  security: {
    ...
    password: {
      title: "הגנת סיסמה",
      description:
        "הגן על מופע ה-Cognivis שלך באמצעות סיסמה. אם תשכח אותה, אין שיטת שחזור, אז ודא שאתה שומר סיסמה זו.",
  ...
  telegram: {
    title: "בוט של טלגרם",
    description:
      "חברו את ההתקנה של Cognivis ל-Telegram, כך שתוכלו לתקשר עם סביבות העבודה שלכם ממכשיר כלשהו.",
    setup: {
      step1: {
