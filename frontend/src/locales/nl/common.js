...
const TRANSLATIONS = {
  onboarding: {
    survey: {
      ...
      useCase: "Waarvoor ga je Cognivis gebruiken?",
      useCaseWork: "Voor werk",
      useCasePersonal: "Voor persoonlijk gebruik",
      useCaseOther: "Anders",
      comment: "Hoe heb je over Cognivis gehoord?",
      commentPlaceholder:
      ...
      title: "Welkom bij Cognivis",
      description:
        "Help ons Cognivis af te stemmen op jouw behoeften. (Optioneel)",
    },
    home: {
    ...
    llm: {
      ...
      description:
        "Cognivis kan samenwerken met veel LLM-aanbieders. Deze service verzorgt de chatfunctie.",
    },
    userSetup: {
  ...
  settings: {
    ...
    chat: "Chat",
    "mobile-app": "Cognivis Mobiele App",
    "community-hub": {
      title: "Centraal punt",
  ...
  general: {
    ...
    message: {
      ...
      heading: "Leg me uit",
      body: "de voordelen van Cognivis",
    },
    delete: {
  ...
  agent: {
    ...
    settings: {
      ...
      "intelligent-skill-selection": {
        ...
        "beta-badge": "Betaling",
        description:
          'Maak gebruik van een onbeperkt aantal tools en verminder het gebruik van "cut tokens" met tot wel 80% per query – Cognivis selecteert automatisch de juiste vaardigheden voor elke vraag.',
        "max-tools": {
          title: "Max Tools",
          description:
  ...
  api: {
    title: "API-sleutels",
    description:
      "API-sleutels stellen de houder in staat om deze Cognivis-instantie programmatisch te openen en beheren.",
    ...
    modal: {
      ...
      helper:
        "Na het aanmaken kan de API-sleutel worden gebruikt om programmatisch toegang te krijgen tot deze Cognivis-instantie en deze te configureren.",
      name: {
        label: "Naam",
  ...
  llm: {
    title: "LLM Voorkeur",
    description:
      "Dit zijn de inloggegevens en instellingen voor je voorkeurs LLM-chat & inbeddingprovider. Het is belangrijk dat deze sleutels actueel en correct zijn, anders zal Cognivis niet goed werken.",
  ...
  transcription: {
    ...
    "warn-start":
      "Het gebruik van het lokale fluistermodel op machines met beperkte RAM of CPU kan Cognivis vertragen bij het verwerken van mediabestanden.",
    "warn-recommend":
  ...
  embedding: {
    ...
    "desc-end":
      "Inbedding is het proces van het omzetten van tekst in vectoren. Deze inloggegevens zijn vereist om je bestanden en prompts om te zetten naar een formaat dat Cognivis kan gebruiken om te verwerken.",
    provider: {
  ...
  vector: {
    ...
    description:
      "Dit zijn de inloggegevens en instellingen voor hoe je Cognivis-instantie zal functioneren. Het is belangrijk dat deze sleutels actueel en correct zijn.",
    provider: {
  ...
  privacy: {
    ...
    description:
      "Dit is je configuratie voor hoe verbonden derden en Cognivis je gegevens verwerken.",
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "Deze bestanden worden geüpload naar de documentverwerker die op deze Cognivis-instantie draait. Deze bestanden worden niet verzonden naar of gedeeld met derden.",
    },
    pinning: {
      what_pinning: "Wat is het vastzetten van documenten?",
      pin_explained_block1:
        "Wanneer u een document vastzet in Cognivis, injecteren we de volledige inhoud van het document in uw promptvenster, zodat uw LLM het volledig kan begrijpen.",
      ...
      pin_explained_block3:
        "Als u standaard niet de gewenste antwoorden krijgt van Cognivis, is vastzetten een uitstekende manier om met één klik antwoorden van hogere kwaliteit te krijgen.",
      accept: "Oké, begrepen.",
    },
    watching: {
      what_watching: "Wat doet het volgen van een document?",
      watch_explained_block1:
        "Wanneer u een document in Cognivis volgt, synchroniseren we de inhoud van uw document automatisch met regelmatige tussenpozen vanuit de originele bron. Hierdoor wordt de inhoud in elke werkruimte waar dit bestand wordt beheerd automatisch bijgewerkt.",
  ...
  chat_window: {
    ...
    memories: {
      ...
      modal: {
        ...
        label: "Geheugen",
        placeholder:
          "bijvoorbeeld: De naam van de gebruiker is Joe, de gebruiker werkt aan Cognivis, enz.",
        create: "Creëren",
        save: "Opslaan",
        cancel: "Annuleren",
      },
  ...
  customization: {
    interface: {
      title: "UI-voorkeuren",
      description: "Stel uw UI-voorkeuren in voor Cognivis.",
    },
    branding: {
      title: "Branding & Whitelabeling",
      description:
        "Geef uw Cognivis-instantie een whitelabel met uw eigen branding.",
    },
    chat: {
      title: "Chat",
      description: "Stel uw chatvoorkeuren in voor Cognivis.",
      auto_submit: {
    ...
    items: {
      ...
      "display-language": {
        title: "Weergavetaal",
        description:
          "Selecteer de gewenste taal waarin de gebruikersinterface van Cognivis moet worden weergegeven - wanneer vertalingen beschikbaar zijn.",
      },
      logo: {
        title: "Merklogo",
    ...
    publish: {
      ...
      generic: {
        unauthenticated: {
          ...
          description:
            "U moet zich authenticeren bij de Cognivis Community Hub voordat u items kunt publiceren.",
  ...
  security: {
    ...
    password: {
      ...
      description:
        "Bescherm je Cognivis-instantie met een wachtwoord. Als je dit vergeet, is er geen herstelmethode, dus zorg ervoor dat je dit wachtwoord opslaat.",
  ...
  telegram: {
    title: "Telegram Bot",
    description:
      "Verbind uw Cognivis-instantie met Telegram, zodat u vanuit elk apparaat kunt communiceren met uw werkruimtes.",
    setup: {
      step1: {
