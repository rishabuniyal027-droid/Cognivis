...
const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      ...
      description:
        "Cognivis peut fonctionner avec de nombreux fournisseurs LLM. Ce sera le service qui traitera vos discussions.",
    },
    userSetup: {
    ...
    data: {
      ...
      description:
        "Configurez comment Cognivis stocke et traite vos données.",
      settingsHint:
  ...
  general: {
    ...
    message: {
      ...
      body: "les avantages de Cognivis",
    },
    delete: {
  ...
  agent: {
    ...
    settings: {
      ...
      "intelligent-skill-selection": {
        ...
        "beta-badge": "Bêta",
        description:
          "Permettez l'utilisation illimitée d'outils et réduisez la consommation de jetons jusqu'à 80 % par requête – Cognivis sélectionne automatiquement les compétences appropriées pour chaque requête.",
        "max-tools": {
          title: "Max Tools",
          description:
  ...
  api: {
    title: "Clés API",
    description:
      "Les clés API permettent au titulaire d'accéder et de gérer de manière programmatique cette instance Cognivis.",
    ...
    modal: {
      ...
      helper:
        "Une fois créée, la clé API peut être utilisée pour accéder à cette instance Cognivis et la configurer de manière programmatique.",
      name: {
        label: "Nom",
  ...
  llm: {
    title: "Préférence LLM",
    description:
      "Voici les identifiants et les paramètres de votre fournisseur LLM de chat et d'intégration préféré. Il est important que ces clés soient actuelles et correctes, sinon Cognivis ne fonctionnera pas correctement.",
  ...
  transcription: {
    ...
    "warn-start":
      "L'utilisation du modèle local whisper sur des machines avec une RAM ou un CPU limités peut bloquer Cognivis lors du traitement des fichiers multimédias.",
    "warn-recommend":
  ...
  embedding: {
    ...
    "desc-end":
      "L'intégration est le processus de transformation du texte en vecteurs. Ces identifiants sont nécessaires pour transformer vos fichiers et invites en un format que Cognivis peut utiliser pour traiter.",
    provider: {
  ...
  vector: {
    ...
    description:
      "Voici les identifiants et les paramètres de fonctionnement de votre instance Cognivis. Il est important que ces clés soient actuelles et correctes.",
    provider: {
  ...
  privacy: {
    ...
    description:
      "Voici votre configuration pour la gestion des données et des fournisseurs tiers connectés avec Cognivis.",
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "Ces fichiers seront téléchargés sur cette instance Cognivis uniquement.",
    },
    pinning: {
      what_pinning: "Qu'est-ce que l'épinglage de documents ?",
      pin_explained_block1:
        "Lorsque vous épinglez un document, Cognivis injectera le contenu intégral du document dans votre fenêtre de prompt comme contexte préalable pour chaque interaction.",
    ...
    watching: {
      ...
      watch_explained_block1:
        "Lorsque vous surveillez un document, Cognivis re-synchronisera automatiquement le contenu du document depuis sa source de manière périodique.",
  ...
  chat_window: {
    ...
    memories: {
      ...
      modal: {
        ...
        label: "Mémoire",
        placeholder:
          "Par exemple, le nom de l'utilisateur est Joe, l'utilisateur travaille sur Cognivis, etc.",
        create: "Créer",
        save: "Enregistrer",
        cancel: "Annuler",
      },
    ...
    publish: {
      ...
      generic: {
        unauthenticated: {
          ...
          description:
            "Vous devez vous connecter à votre compte Cognivis pour publier sur le Community Hub.",
          button: "Se connecter",
        },
      },
      slash_command: {
  ...
  security: {
    ...
    password: {
      ...
      description:
        "Protégez votre instance Cognivis avec un mot de passe. Si vous oubliez ce mot de passe, il n'y a pas de méthode de récupération, donc assurez-vous de le sauvegarder.",
  ...
  telegram: {
    title: "Bot Telegram",
    description:
      "Connectez votre instance de Cognivis à Telegram afin de pouvoir communiquer avec vos espaces de travail depuis n'importe quel appareil.",
    setup: {
      step1: {
