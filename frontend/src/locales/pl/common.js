...
const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      ...
      description:
        "Cognivis może współpracować z wieloma dostawcami modeli językowych",
    },
    userSetup: {
    ...
    survey: {
      title: "Witamy w Cognivis",
      description:
        "Pomóż nam stworzyć Cognivis dostosowany do Twoich potrzeb. Opcjonalnie.",
      email: "Jaki jest Twój adres e-mail?",
      useCase: "Do czego będziesz używać Cognivis?",
      useCaseWork: "Do pracy",
      useCasePersonal: "Do użytku osobistego",
      useCaseOther: "Inne",
      comment: "Skąd dowiedziałeś się o Cognivis?",
      commentPlaceholder:
  ...
  customization: {
    interface: {
      ...
      description: "Ustaw preferencje interfejsu użytkownika dla Cognivis.",
    },
    branding: {
      title: "Branding i white-labeling",
      description:
        "Oznakuj swoją instancję Cognivis niestandardowym brandingiem.",
    },
    chat: {
      title: "Czat",
      description: "Ustaw preferencje czatu dla Cognivis.",
      auto_submit: {
    ...
    items: {
      ...
      "display-language": {
        title: "Język",
        description:
          "Wybierz preferowany język interfejsu użytkownika Cognivis - jeśli dostępne są tłumaczenia.",
      },
      logo: {
        title: "Logo",
        description:
  ...
  api: {
    title: "Klucze API",
    description:
      "Klucze API umożliwiają dostęp do instancji Cognivis i zarządzanie nią.",
    ...
    modal: {
      ...
      helper:
        "Po utworzeniu klucz API może być używany do programowego dostępu do tej instancji Cognivis i jej konfiguracji.",
      name: {
        label: "Nazwa",
  ...
  llm: {
    ...
    description:
      "Tutaj skonfigurujesz dostawcę modeli językowych używanych do czatów i embeddingów. Upewnij się, że wszystkie klucze są aktualne i poprawne - bez tego Cognivis nie będzie działać.",
  ...
  transcription: {
    ...
    "warn-start":
      "Korzystanie z lokalnego modelu Whisper na komputerach z ograniczoną pamięcią RAM lub procesorem może spowodować przerwanie pracy Cognivis podczas przetwarzania plików multimedialnych.",
    "warn-recommend":
  ...
  vector: {
    ...
    description:
      "Tutaj skonfigurujesz wektorową bazę danych dla Cognivis. Upewnij się, że wszystkie ustawienia są poprawne.",
    provider: {
      title: "Wektorowa baza danych",
  ...
  privacy: {
    ...
    description:
      "Jest to konfiguracja sposobu, w jaki połączeni dostawcy zewnętrzni i Cognivis przetwarzają dane użytkownika.",
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "Pliki zostaną przetworzone w obrębie danej instancji Cognivis. Pliki te nie będą udostępniane innym podmiotom.",
    },
    pinning: {
      what_pinning: "Czym jest przypinanie dokumentów?",
      pin_explained_block1:
        "Kiedy <b>przypinasz</b> dokument w Cognivis, dodamy całą zawartość dokumentu do okna promptu, aby LLM mógł w pełni zrozumieć jego treść.",
      ...
      pin_explained_block3:
        "Jeśli domyślnie nie otrzymujesz pożądanych odpowiedzi z Cognivis, przypinanie jest świetnym sposobem na uzyskanie wyższej jakości odpowiedzi za jednym kliknięciem.",
      accept: "Ok, rozumiem",
    },
    watching: {
      what_watching: "Do czego służy oglądanie dokumentu?",
      watch_explained_block1:
        "Podczas <b>obserwowania</b> dokumentu w Cognivis będziemy <i>automatycznie</i> synchronizować zawartość dokumentu z jego oryginalnym źródłem w regularnych odstępach czasu. Spowoduje to automatyczną aktualizację zawartości w każdym obszarze roboczym, w którym ten plik jest zarządzany.",
  ...
  chat_window: {
    ...
    memories: {
      ...
      modal: {
        ...
        label: "Pamięć",
        placeholder:
          "np. Imię użytkownika to Joe, użytkownik pracuje w firmie Cognivis, itp.",
        create: "Stwórz",
        save: "Zapisz",
        cancel: "Anuluj",
      },
    ...
    publish: {
      ...
      generic: {
        unauthenticated: {
          ...
          description:
            "Przed opublikowaniem elementów należy uwierzytelnić się w centrum społeczności Cognivis.",
  ...
  security: {
    ...
    password: {
      ...
      description:
        "Chroń swoją instancję Cognivis hasłem. Jeśli go zapomnisz, nie ma metody odzyskiwania, więc upewnij się, że zapisałeś to hasło.",
  ...
  telegram: {
    ...
    description:
      "Połącz swoją instancję Cognivis z Telegramem, aby móc rozmawiać z przestrzeniami roboczymi z dowolnego urządzenia.",
    setup: {
      step1: {
