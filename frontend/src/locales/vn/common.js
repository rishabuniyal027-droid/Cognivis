...
const TRANSLATIONS = {
  onboarding: {
    survey: {
      ...
      useCase: "Bạn sẽ sử dụng Cognivis để làm gì?",
      useCaseWork: "Cho công việc",
      useCasePersonal: "Cho mục đích cá nhân",
      useCaseOther: "Khác",
      comment: "Bạn biết đến Cognivis như thế nào?",
      commentPlaceholder:
      ...
      title: "Chào mừng đến với Cognivis",
      description:
        "Giúp chúng tôi xây dựng Cognivis phù hợp với nhu cầu của bạn. Tùy chọn.",
    },
    home: {
      getStarted: "Bắt đầu",
      welcome: "Chào mừng",
    ...
    llm: {
      title: "Tùy chọn LLM",
      description:
        "Cognivis có thể hoạt động với nhiều nhà cung cấp LLM. Đây sẽ là dịch vụ xử lý trò chuyện.",
    },
    userSetup: {
  ...
  agent: {
    ...
    settings: {
      ...
      "intelligent-skill-selection": {
        ...
        description:
          "Cho phép sử dụng không giới hạn các công cụ và giảm mức sử dụng token lên đến 80% cho mỗi truy vấn – Cognivis tự động chọn các kỹ năng phù hợp nhất cho mỗi yêu cầu.",
        "max-tools": {
          title: "Công cụ Max",
          description:
  ...
  api: {
    title: "Khóa API",
    description:
      "Khóa API cho phép người sở hữu truy cập và quản lý phiên bản Cognivis này theo chương trình.",
    ...
    modal: {
      ...
      create: "Tạo khóa API",
      helper:
        "Sau khi được tạo, khóa API có thể được dùng để truy cập và cấu hình phiên bản Cognivis này theo chương trình.",
      name: {
        label: "Tên",
  ...
  llm: {
    title: "Tùy chọn LLM",
    description:
      "Đây là thông tin đăng nhập và cài đặt cho nhà cung cấp LLM trò chuyện & nhúng ưa thích của bạn. Điều quan trọng là các khóa này phải chính xác, nếu không Cognivis sẽ không hoạt động đúng.",
  ...
  transcription: {
    ...
    "warn-start":
      "Sử dụng mô hình whisper cục bộ trên máy có RAM hoặc CPU hạn chế có thể làm Cognivis bị treo khi xử lý tệp media.",
    "warn-recommend":
  ...
  embedding: {
    ...
    "desc-end":
      "Nhúng là quá trình chuyển đổi văn bản thành vector. Thông tin đăng nhập này cần thiết để chuyển đổi tệp và prompt của bạn thành định dạng mà Cognivis có thể sử dụng để xử lý.",
    provider: {
  ...
  vector: {
    ...
    description:
      "Đây là thông tin đăng nhập và cài đặt cho cách phiên bản Cognivis của bạn sẽ hoạt động. Điều quan trọng là các khóa này phải chính xác.",
    provider: {
  ...
  privacy: {
    ...
    description:
      "Đây là cấu hình của bạn về cách các nhà cung cấp bên thứ ba được kết nối và Cognivis xử lý dữ liệu của bạn.",
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "Các tệp này sẽ được tải lên trình xử lý tài liệu đang chạy trên phiên bản Cognivis này. Các tệp này không được gửi hoặc chia sẻ với bên thứ ba.",
    },
    pinning: {
      what_pinning: "Ghim tài liệu là gì?",
      pin_explained_block1:
        "Khi bạn <b>ghim</b> một tài liệu trong Cognivis, chúng tôi sẽ đưa toàn bộ nội dung của tài liệu vào cửa sổ prompt của bạn để LLM hiểu đầy đủ.",
      pin_explained_block2:
        "Điều này hoạt động tốt nhất với <b>mô hình ngữ cảnh lớn</b> hoặc các tệp nhỏ quan trọng với cơ sở kiến thức của nó.",
      pin_explained_block3:
        "Nếu bạn không nhận được câu trả lời mong muốn từ Cognivis theo mặc định, ghim là một cách tuyệt vời để có được câu trả lời chất lượng cao hơn chỉ với một cú nhấp chuột.",
      accept: "Ok, tôi hiểu rồi",
    },
    watching: {
      what_watching: "Theo dõi tài liệu làm gì?",
      watch_explained_block1:
        "Khi bạn <b>theo dõi</b> một tài liệu trong Cognivis, chúng tôi sẽ <i>tự động</i> đồng bộ nội dung tài liệu của bạn từ nguồn gốc theo các khoảng thời gian đều đặn. Điều này sẽ tự động cập nhật nội dung trong mọi không gian làm việc nơi tệp này được quản lý.",
  ...
  chat_window: {
    ...
    memories: {
      ...
      modal: {
        ...
        label: "Bộ nhớ",
        placeholder:
          "Ví dụ: Tên người dùng là Joe, người dùng làm việc trên Cognivis, v.v.",
        create: "Tạo",
        save: "Lưu",
        cancel: "Hủy",
      },
  ...
  customization: {
    interface: {
      ...
      description: "Đặt tùy chọn giao diện của bạn cho Cognivis.",
    },
    branding: {
      title: "Thương hiệu & Nhãn trắng",
      description:
        "Nhãn trắng phiên bản Cognivis của bạn với thương hiệu tùy chỉnh.",
    },
    chat: {
      title: "Trò chuyện",
      description: "Đặt tùy chọn trò chuyện của bạn cho Cognivis.",
      auto_submit: {
    ...
    items: {
      ...
      "display-language": {
        ...
        description:
          "Chọn ngôn ngữ ưa thích để hiển thị giao diện người dùng của Cognivis - khi bản dịch có sẵn.",
      },
      logo: {
    ...
    publish: {
      ...
      generic: {
        unauthenticated: {
          ...
          description:
            "Bạn cần xác thực với Cognivis Community Hub trước khi đăng các mục.",
  ...
  security: {
    ...
    password: {
      ...
      description:
        "Bảo vệ phiên bản Cognivis của bạn bằng mật khẩu. Nếu bạn quên mật khẩu này, không có phương pháp khôi phục nên hãy đảm bảo lưu mật khẩu này.",
  ...
  telegram: {
    title: "Bot Telegram",
    description:
      "Kết nối phiên bản Cognivis của bạn với Telegram để bạn có thể trò chuyện với các không gian làm việc của mình từ bất kỳ thiết bị nào.",
    setup: {
      step1: {
