...
const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      ...
      description:
        "Cognivis puede funcionar con muchos proveedores de LLM. Este será el servicio que gestionará el chat.",
    },
    userSetup: {
    ...
    survey: {
      title: "Bienvenido a Cognivis",
      description:
        "Ayúdanos a hacer que Cognivis se adapte a tus necesidades. Opcional.",
      email: "¿Cuál es tu correo electrónico?",
      useCase: "¿Para qué usarás Cognivis?",
      useCaseWork: "Para el trabajo",
      useCasePersonal: "Para uso personal",
      useCaseOther: "Otro",
      comment: "¿Cómo te enteraste de Cognivis?",
      commentPlaceholder:
  ...
  general: {
    ...
    message: {
      ...
      heading: "Explícame",
      body: "los beneficios de Cognivis",
    },
    delete: {
  ...
  agent: {
    ...
    settings: {
      ...
      "intelligent-skill-selection": {
        ...
        description:
          "Permite el uso ilimitado de herramientas y reduce el consumo de tokens hasta en un 80% por consulta: Cognivis selecciona automáticamente las habilidades adecuadas para cada solicitud.",
        "max-tools": {
  ...
  customization: {
    interface: {
      ...
      description:
        "Establece tus preferencias de la interfaz de usuario para Cognivis.",
    },
    branding: {
      title: "Marca y marca blanca",
      description:
        "Personaliza tu instancia de Cognivis con tu propia marca.",
    },
    chat: {
      title: "Chat",
      description: "Establece tus preferencias de chat para Cognivis.",
      auto_submit: {
    ...
    items: {
      ...
      "display-language": {
        ...
        description:
          "Selecciona el idioma preferido para renderizar la interfaz de usuario de Cognivis, cuando las traducciones estén disponibles.",
      },
      logo: {
  ...
  api: {
    title: "Claves de API",
    description:
      "Las claves de API permiten al titular acceder y administrar programáticamente esta instancia de Cognivis.",
    ...
    modal: {
      ...
      helper:
        "Una vez creada, la clave API se puede usar para acceder y configurar esta instancia de Cognivis mediante programación.",
      name: {
        label: "Nombre",
  ...
  llm: {
    title: "Preferencia de LLM",
    description:
      "Estas son las credenciales y la configuración de tu proveedor preferido de chat e incrustación de LLM. Es importante que estas claves estén actualizadas y sean correctas, de lo contrario, Cognivis no funcionará correctamente.",
  ...
  transcription: {
    ...
    "warn-start":
      "El uso del modelo local de Whisper en máquinas con RAM o CPU limitadas puede detener Cognivis al procesar archivos multimedia.",
    "warn-recommend":
  ...
  embedding: {
    ...
    "desc-end":
      "La incrustación es el proceso de convertir texto en vectores. Estas credenciales son necesarias para convertir tus archivos y prompts en un formato que Cognivis pueda usar para procesar.",
    provider: {
  ...
  vector: {
    ...
    description:
      "Estas son las credenciales y la configuración de cómo funcionará tu instancia de Cognivis. Es importante que estas claves estén actualizadas y sean correctas.",
    provider: {
  ...
  privacy: {
    ...
    description:
      "Esta es tu configuración sobre cómo los proveedores de terceros conectados y Cognivis manejan tus datos.",
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "Estos archivos se subirán al procesador de documentos que se ejecuta en esta instancia de Cognivis. Estos archivos no se envían ni se comparten con terceros.",
    },
    pinning: {
      what_pinning: "¿Qué es fijar documentos?",
      pin_explained_block1:
        "Cuando <b>fijas</b> un documento en Cognivis, inyectaremos todo el contenido del documento en tu ventana de prompt para que tu LLM lo comprenda por completo.",
      ...
      pin_explained_block3:
        "Si no obtienes las respuestas que deseas de Cognivis por defecto, fijar es una excelente manera de obtener respuestas de mayor calidad con un clic.",
      accept: "Ok, entendido",
    },
    watching: {
      what_watching: "¿Qué hace observar un documento?",
      watch_explained_block1:
        "Cuando <b>observas</b> un documento en Cognivis, sincronizaremos <i>automáticamente</i> el contenido de tu documento desde su fuente original a intervalos regulares. Esto actualizará automáticamente el contenido en cada espacio de trabajo donde se gestione este archivo.",
  ...
  chat_window: {
    ...
    memories: {
      ...
      modal: {
        ...
        label: "Memoria",
        placeholder:
          "Por ejemplo, el nombre del usuario es Joe, el usuario trabaja en Cognivis, etc.",
        create: "Crear",
        save: "Guardar",
        cancel: "Cancelar",
      },
    ...
    publish: {
      ...
      generic: {
        unauthenticated: {
          ...
          description:
            "Necesitas autenticarte con el Centro de la Comunidad de Cognivis antes de publicar elementos.",
  ...
  security: {
    ...
    password: {
      ...
      description:
        "Protege tu instancia de Cognivis con una contraseña. Si la olvidas, no hay método de recuperación, así que asegúrate de guardar esta contraseña.",
  ...
  telegram: {
    ...
    description:
      "Conecte su instancia de Cognivis a Telegram para poder conversar con sus espacios de trabajo desde cualquier dispositivo.",
    setup: {
      step1: {
