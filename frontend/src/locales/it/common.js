...
const TRANSLATIONS = {
  onboarding: {
    survey: {
      ...
      useCase: "Quali utilizzi intende fare con Cognivis?",
      useCaseWork: "Per lavoro",
      useCasePersonal: "Per uso personale",
      useCaseOther: "Altro",
      comment: "Come ha saputo di Cognivis?",
      commentPlaceholder:
      ...
      title: "Benvenuti in Cognivis",
      description:
        "Aiutaci a sviluppare Cognivis in base alle tue esigenze. Facoltativo.",
    },
    home: {
      getStarted: "Inizia",
      welcome: "Benvenuti",
    ...
    llm: {
      ...
      description:
        "Cognivis può collaborare con numerosi fornitori di modelli linguistici. Questo sarà il servizio che gestirà le conversazioni.",
    },
    userSetup: {
  ...
  agent: {
    ...
    settings: {
      ...
      "intelligent-skill-selection": {
        ...
        description:
          "Abilita l'uso illimitato degli strumenti e riduci l'utilizzo dei token fino all'80% per ogni query — Cognivis seleziona automaticamente le competenze più appropriate per ogni richiesta.",
        "max-tools": {
          title: "Max Tools",
          description:
  ...
  api: {
    title: "Chiavi API",
    description:
      "Le chiavi API consentono al titolare di accedere e gestire in modo programmatico questa istanza Cognivis.",
    ...
    modal: {
      ...
      helper:
        "Una volta creata, la chiave API può essere usata per accedere e configurare questa istanza Cognivis in modo programmatico.",
      name: {
        label: "Nome",
  ...
  llm: {
    ...
    description:
      "Queste sono le credenziali e le impostazioni per il tuo provider di chat e embedding LLM preferito. È importante che queste chiavi siano aggiornate e corrette, altrimenti Cognivis non funzionerà correttamente.",
  ...
  transcription: {
    ...
    "warn-start":
      "L'utilizzo del modello whisper locale su macchine con RAM o CPU limitate può bloccare Cognivis durante l'elaborazione di file multimediali.",
    "warn-recommend":
  ...
  embedding: {
    ...
    "desc-end":
      "L'embedding è il processo di trasformazione del testo in vettori. Queste credenziali sono necessarie per trasformare i file e i prompt in un formato che Cognivis può utilizzare per l'elaborazione.",
    provider: {
  ...
  vector: {
    ...
    description:
      "Queste sono le credenziali e le impostazioni per il funzionamento della tua istanza Cognivis. È importante che queste chiavi siano aggiornate e corrette.",
    provider: {
  ...
  privacy: {
    ...
    description:
      "Questa è la tua configurazione per il modo in cui i provider terzi connessi e Cognivis gestiscono i tuoi dati.",
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "Questi file verranno caricati nel processore di documenti in esecuzione su questa istanza di Cognivis. Questi file non vengono inviati o condivisi con terzi.",
    },
    pinning: {
      what_pinning: 'Cos\'è il "pinning" di un documento?',
      pin_explained_block1:
        'Quando si "fissa" un documento in Cognivis, caricheremo l\'intero contenuto del documento nella finestra di prompt per il tuo modello linguistico, in modo che possa comprenderlo appieno.',
      ...
      pin_explained_block3:
        'Se non ottenete le risposte desiderate da Cognivis per impostazione predefinita, allora l\'utilizzo del "pinning" è un ottimo modo per ottenere risposte di qualità superiore in pochi clic.',
      accept: "Ok, ho capito.",
    },
    watching: {
      what_watching: "Cosa si ottiene guardando un documentario?",
      watch_explained_block1:
        "Quando visualizzi un documento in Cognivis, il sistema <i>sincronizzerà automaticamente</i> il contenuto del documento dalla sua fonte originale a intervalli regolari. Ciò aggiornerà automaticamente il contenuto in tutti gli spazi di lavoro in cui questo file è gestito.",
  ...
  chat_window: {
    ...
    memories: {
      ...
      modal: {
        ...
        label: "Memoria",
        placeholder:
          "ad esempio, il nome dell'utente è Joe, l'utente lavora su Cognivis, ecc.",
        create: "Creare",
        save: "Salva",
        cancel: "Annulla",
      },
  ...
  customization: {
    interface: {
      ...
      description:
        "Configura le tue preferenze dell'interfaccia utente per Cognivis.",
    },
    branding: {
      title: "Branding e personalizzazione",
      description:
        "Personalizza la tua istanza di Cognivis con il tuo marchio.",
    },
    chat: {
      title: "Chat",
      description: "Configura le tue preferenze di chat per Cognivis.",
      auto_submit: {
    ...
    items: {
      ...
      "display-language": {
        ...
        description:
          "Seleziona la lingua preferita per visualizzare l'interfaccia utente di Cognivis – quando sono disponibili le traduzioni.",
      },
      logo: {
    ...
    publish: {
      ...
      generic: {
        unauthenticated: {
          ...
          description:
            "È necessario autenticarsi tramite il Community Hub di Cognivis prima di pubblicare contenuti.",
  ...
  security: {
    ...
    password: {
      ...
      description:
        "Proteggi la tua istanza Cognivis con una password. Se la dimentichi, non esiste un metodo di recupero, quindi assicurati di salvare questa password.",
  ...
  telegram: {
    ...
    description:
      "Collega la tua istanza di Cognivis a Telegram in modo da poter chattare con i tuoi spazi di lavoro da qualsiasi dispositivo.",
    setup: {
      step1: {
