...
const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      title: "LLM 偏好",
      description:
        "Cognivis 可搭配多種 LLM 提供者使用。這項服務會負責處理對話。",
    },
    userSetup: {
      title: "使用者設定",
      description: "設定使用者偏好。",
    ...
    survey: {
      title: "歡迎使用 Cognivis",
      description: "協助我們打造更符合需求的 Cognivis。此問卷為選填。",
      email: "您的電子郵件是什麼？",
      useCase: "您將如何使用 Cognivis？",
      useCaseWork: "用於工作",
      useCasePersonal: "用於個人使用",
      useCaseOther: "其他",
      comment: "您是從哪裡知道 Cognivis 的？",
      commentPlaceholder:
        "例如 Reddit、Twitter、GitHub、YouTube 等，告訴我們您是怎麼找到 Cognivis 的！",
      skip: "略過問卷",
      thankYou: "感謝您的回饋！",
    },
  },
  ...
  agent: {
    ...
    settings: {
      ...
      "intelligent-skill-selection": {
        ...
        "beta-badge": "β 版本",
        description:
          "啟用無限多個工具，並將每個查詢的 token 使用量最多降低 80% — Cognivis 能夠自動選擇最適合的技能，以處理每一個提示。",
        "max-tools": {
          title: "馬克斯工具",
          description:
  ...
  api: {
    title: "API 金鑰",
    description:
      "API 金鑰可讓持有人透過程式方式存取並管理這個 Cognivis 系統。",
    link: "閱讀 API 文件",
    ...
    modal: {
      ...
      create: "建立 API 金鑰",
      helper:
        "建立後，API 金鑰可用於以程式方式存取並設定這個 Cognivis 執行個體。",
      name: {
        label: "名稱",
        placeholder: "正式環境整合",
  ...
  llm: {
    title: "LLM 偏好設定",
    description:
      "這裡設定偏好的 LLM 對話與嵌入提供者之認證資訊與參數。請確認金鑰保持最新且正確，否則 Cognivis 可能無法正常運作。",
    provider: "LLM 提供者",
    providers: {
      azure_openai: {
  ...
  transcription: {
    ...
    provider: "語音轉錄提供者",
    "warn-start":
      "在記憶體或 CPU 資源有限的電腦上使用本機 Whisper 模型時，處理媒體檔案可能會讓 Cognivis 卡住。",
  ...
  embedding: {
    ...
    "desc-end":
      "嵌入是把文字轉成向量的過程。這些認證資訊用來把檔案與提示詞轉成 Cognivis 可處理的格式。",
    provider: {
      title: "向量嵌入提供者",
    },
  },
  ...
  vector: {
    title: "向量資料庫",
    description:
      "這裡設定 Cognivis 系統運作所需的認證資訊與參數。請務必確認金鑰保持最新且正確。",
    provider: {
      title: "向量資料庫提供者",
  ...
  privacy: {
    title: "隱私與資料處理",
    description: "這裡設定已連線的第三方提供者與 Cognivis 會如何處理資料。",
    anonymous: "已啟用匿名遙測",
  },
  connectors: {
    ...
    upload: {
      ...
      "fetch-website": "擷取網站",
      "privacy-notice":
        "這些檔案會上傳到此 Cognivis 系統上的文件處理器，不會傳送給或分享給第三方。",
    },
    pinning: {
      what_pinning: "什麼是文件釘選？",
      pin_explained_block1:
        "當您在 Cognivis 中<b>釘選</b>文件時，系統會把整份文件的內容注入提示詞輸入區，讓 LLM 能完整理解。",
      pin_explained_block2:
        "這最適合搭配<b>大上下文模型</b>，或對知識庫很重要的小型文件。",
      pin_explained_block3:
        "如果 Cognivis 在預設情況下給不出想要的答案，釘選文件是快速提升回答品質的好方法。",
      accept: "好的，明白了",
    },
    watching: {
      what_watching: "追蹤文件有何作用？",
      watch_explained_block1:
        "當您在 Cognivis 中<b>追蹤</b>文件時，系統會<i>自動</i>定期從原始來源同步內容，並更新所有管理這份文件的工作區。",
  ...
  chat_window: {
    ...
    memories: {
      ...
      modal: {
        ...
        label: "記憶",
        placeholder: "例如：使用者姓名為 Joe，使用者正在使用 Cognivis 等。",
        create: "創造",
        save: "儲存",
        cancel: "取消",
      },
  ...
  customization: {
    interface: {
      title: "介面偏好設定",
      description: "設定 Cognivis 的介面偏好。",
    },
    branding: {
      title: "品牌與白標設定",
      description: "透過自訂品牌元素，將 Cognivis 白標化。",
    },
    chat: {
      title: "對話",
      description: "設定 Cognivis 的對話偏好。",
      auto_submit: {
        title: "語音輸入自動送出",
    ...
    items: {
      ...
      "display-language": {
        title: "顯示語言",
        description: "選擇 Cognivis 介面的顯示語言；若已有翻譯就會套用。",
      },
      logo: {
        title: "品牌標誌",
  ...
  community_hub: {
    publish: {
      ...
      generic: {
        unauthenticated: {
          title: "需要驗證",
          description: "發布項目前，需先完成 Cognivis 社群中心驗證。",
          button: "連接到社群中心",
        },
      },
      slash_command: {
  ...
  security: {
    ...
    password: {
      title: "密碼保護",
      description:
        "使用密碼保護 Cognivis 系統。若忘記此密碼，將無法復原，請務必妥善保存。",
      "password-label": "系統密碼",
    },
  },
  home: {
  ...
  telegram: {
    title: "Telegram 機器人",
    description:
      "將您的 Cognivis 實例連接到 Telegram，以便您可以在任何裝置上與您的工作空間進行對話。",
    setup: {
      step1: {
