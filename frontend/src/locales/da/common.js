...
const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      ...
      description:
        "Cognivis kan arbejde med mange LLM-udbydere. Dette vil være den tjeneste, der håndterer chat.",
    },
    userSetup: {
    ...
    survey: {
      title: "Velkommen til Cognivis",
      description:
        "Hjælp os med at gøre Cognivis tilpasset dine behov. Valgfrit.",
      email: "Hvad er din e-mail?",
      useCase: "Hvad vil du bruge Cognivis til?",
      useCaseWork: "Til arbejde",
      useCasePersonal: "Til personligt brug",
      useCaseOther: "Andet",
      comment: "Hvordan hørte du om Cognivis?",
      commentPlaceholder:
  ...
  agent: {
    ...
    settings: {
      ...
      "intelligent-skill-selection": {
        ...
        "beta-badge": "Beta",
        description:
          "Aktiver ubegrænsede værktøjer og reducer brugen af cut-tokens med op til 80 % pr. forespørgsel – Cognivis vælger automatisk de relevante færdigheder til hver forespørgsel.",
        "max-tools": {
          title: "Max Tools",
          description:
  ...
  api: {
    title: "API-nøgler",
    description:
      "API-nøgler giver indehaveren mulighed for programmatisk at få adgang til og administrere denne Cognivis-instans.",
    ...
    modal: {
      ...
      helper:
        "Når API-nøglen er oprettet, kan den bruges til programmatisk at få adgang til og konfigurere denne Cognivis-instans.",
      name: {
        label: "Navn",
  ...
  llm: {
    title: "LLM-præference",
    description:
      "Disse er legitimationsoplysningerne og indstillingerne for din foretrukne LLM chat- og indlejringsudbyder. Det er vigtigt, at disse nøgler er opdaterede og korrekte, ellers vil Cognivis ikke fungere korrekt.",
  ...
  transcription: {
    ...
    "warn-start":
      "Brug af den lokale whisper-model på maskiner med begrænset RAM eller CPU kan få Cognivis til at gå i stå under behandling af mediefiler.",
  ...
  embedding: {
    ...
    "desc-end":
      "Indlejring er processen med at omdanne tekst til vektorer. Disse legitimationsoplysninger er nødvendige for at omdanne dine filer og prompts til et format, som Cognivis kan bruge til behandling.",
    provider: {
  ...
  vector: {
    ...
    description:
      "Disse er legitimationsoplysningerne og indstillingerne for, hvordan din Cognivis-instans vil fungere. Det er vigtigt, at disse nøgler er opdaterede og korrekte.",
    provider: {
  ...
  privacy: {
    ...
    description:
      "Dette er din konfiguration for, hvordan tilsluttede tredjepartsudbydere og Cognivis håndterer dine data.",
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "Disse filer vil blive uploadet til dokumentbehandleren, der kører på denne Cognivis-instans. Filene sendes ikke eller deles med en tredjepart.",
    },
    pinning: {
      what_pinning: "Hvad er dokumentfastlåsning?",
      pin_explained_block1:
        "Når du <b>fastlåser</b> et dokument i Cognivis, vil vi indsætte hele dokumentets indhold i din prompt-vindue, så din LLM kan forstå det fuldt ud.",
      pin_explained_block2:
        "Dette fungerer bedst med <b>store kontekstmodeller</b> eller små filer, der er kritiske for dens vidensbase.",
      pin_explained_block3:
        "Hvis du ikke får de svar, du ønsker fra Cognivis som standard, er fastlåsning en fremragende måde at få svar af højere kvalitet med et enkelt klik.",
      accept: "Okay, jeg har forstået",
    },
    watching: {
      what_watching: "Hvad gør det at overvåge et dokument?",
      watch_explained_block1:
        "Når du <b>overvåger</b> et dokument i Cognivis, vil vi <i>automatisk</i> synkronisere dokumentets indhold fra dets oprindelige kilde med jævne mellemrum. Dette vil automatisk opdatere indholdet i alle arbejdsområder, hvor denne fil administreres.",
  ...
  chat_window: {
    ...
    memories: {
      ...
      modal: {
        ...
        label: "Hukommelse",
        placeholder:
          "f.eks. Brugerens navn er Joe, brugeren arbejder med Cognivis, osv.",
        create: "Opret",
        save: "Gem",
        cancel: "Annullér",
      },
  ...
  customization: {
    interface: {
      ...
      description: "Konfigurer dine præferencer for Cognivis.",
    },
    branding: {
      title: 'Brandstrategi og "white label"-løsninger',
      description: "Mærk din Cognivis-instans med dit eget brand.",
    },
    chat: {
      title: "Chat",
      description: "Angiv dine præferencer for chat med Cognivis.",
      auto_submit: {
    ...
    items: {
      ...
      "display-language": {
        title: "Visningssprog",
        description:
          "Vælg det foretrukne sprog til at vise Cognivis's brugergrænseflade i – når oversættelser er tilgængelige.",
      },
      logo: {
        title: "Brand Logo",
        description:
    ...
    publish: {
      ...
      generic: {
        unauthenticated: {
          ...
          description:
            "Du skal verificere din identitet via Cognivis Community Hub, før du kan publicere indhold.",
  ...
  security: {
    ...
    password: {
      ...
      description:
        "Beskyt din Cognivis-instans med en adgangskode. Hvis du glemmer den, findes der ingen genoprettelsesmetode, så sørg for at gemme denne adgangskode.",
  ...
  telegram: {
    title: "Telegram-bot",
    description:
      "Forbind dit Cognivis-instans med Telegram, så du kan kommunikere med dine arbejdsområder fra enhver enhed.",
    setup: {
      step1: {
