...
const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      title: "LLM 偏好",
      description:
        "Cognivis 可以与多家 LLM 提供商合作。这将是处理聊天的服务。",
    },
    userSetup: {
      title: "用户设置",
    ...
    survey: {
      title: "欢迎使用 Cognivis",
      description: "帮助我们为你的需求打造 Cognivis。可选。",
      email: "你的电子邮件是什么？",
      useCase: "你将如何使用 Cognivis？",
      useCaseWork: "用于工作",
      useCasePersonal: "用于个人使用",
      useCaseOther: "其他",
      comment: "你是如何听说 Cognivis 的？",
      commentPlaceholder:
  ...
  agent: {
    ...
    settings: {
      ...
      "intelligent-skill-selection": {
        ...
        "beta-badge": "β 版本",
        description:
          "实现无限工具和按查询减少高达 80% 的 Token 使用量——Cognivis 能够自动选择最合适的技能，以应对每个提示。",
        "max-tools": {
          title: "麦克斯工具",
          description:
  ...
  customization: {
    interface: {
      title: "界面偏好设置",
      description: "设置您的 Cognivis 界面偏好。",
    },
    branding: {
      title: "品牌与白标设置",
      description: "使用自定义品牌对白标您的 Cognivis 实例。",
    },
    chat: {
      title: "聊天",
      description: "设置您的 Cognivis 聊天偏好。",
      auto_submit: {
        title: "自动提交语音输入",
    ...
    items: {
      ...
      "display-language": {
        title: "显示语言",
        description: "选择显示 Cognivis 界面所用的语言（若有翻译可用）。",
      },
      logo: {
        title: "品牌标志",
  ...
  api: {
    title: "API 密钥",
    description: "API 密钥允许持有者以编程方式访问和管理此 Cognivis 实例。",
    link: "阅读 API 文档",
    ...
    modal: {
      ...
      close: "关闭",
      create: "创建 API 密钥",
      helper: "创建后，API 密钥可用于以编程方式访问并配置此 Cognivis 实例。",
      name: {
        label: "名称",
        placeholder: "生产环境集成",
  ...
  llm: {
    title: "LLM 首选项",
    description:
      "这些是你首选的 LLM 聊天和嵌入提供商的凭据和设置。重要的是，确保这些密钥是最新的和正确的，否则 Cognivis 将无法正常运行。",
    provider: "LLM 提供商",
    providers: {
      azure_openai: {
  ...
  transcription: {
    ...
    provider: "转录提供商",
    "warn-start":
      "在 RAM 或 CPU 有限的计算机上使用本地耳语模型可能会在处理媒体文件时停止 Cognivis。",
  ...
  embedding: {
    ...
    "desc-end":
      "嵌入是将文本转换为矢量的过程。需要这些凭据才能将你的文件和提示转换为 Cognivis 可以用来处理的格式。",
    provider: {
      title: "嵌入引擎提供商",
    },
  },
  ...
  vector: {
    title: "向量数据库",
    description:
      "这些是 Cognivis 实例如何运行的凭据和设置。重要的是，这些密钥是最新的和正确的。",
    provider: {
      title: "向量数据库提供商",
  ...
  privacy: {
    title: "隐私和数据处理",
    description:
      "这是你对如何处理连接的第三方提供商和Cognivis的数据的配置。",
    anonymous: "启用匿名遥测",
  },
  connectors: {
    ...
    upload: {
      ...
      "fetch-website": "获取网站",
      "privacy-notice":
        "这些文件将被上传到此 Cognivis 实例上的文档处理器。这些文件不会发送或共享给第三方。",
    },
    pinning: {
      what_pinning: "什么是文档固定？",
      pin_explained_block1:
        "当您在 Cognivis 中<b>固定</b>一个文档时，我们会将整个文档内容注入到您的提示窗口中，让 LLM 能够完全理解它。",
      pin_explained_block2:
        "这在 <b>大上下文模型</b> 或关键的小文件中效果最佳。",
      pin_explained_block3:
        "如果默认情况下无法从 Cognivis 获取满意的答案，固定文档是提高答案质量的好方法。",
      accept: "好的，知道了",
    },
    watching: {
      what_watching: "什么是监控文档？",
      watch_explained_block1:
        "当您在 Cognivis 中<b>监控</b>一个文档时，我们会<i>自动</i>按定期间隔从其原始来源同步文档内容。系统会自动更新在所有使用该文档的工作区中的内容。",
  ...
  chat_window: {
    ...
    memories: {
      ...
      modal: {
        ...
        label: "记忆",
        placeholder:
          "例如，用户的姓名是 Joe，用户在 Cognivis 上工作，等等。",
        create: "创造",
        save: "保存",
        cancel: "取消",
      },
    ...
    publish: {
      ...
      generic: {
        unauthenticated: {
          title: "需要验证",
          description:
            "在发布项目之前，您需要通过 Cognivis 社区中心进行验证。",
          button: "连接到社区中心",
        },
      },
      slash_command: {
  ...
  security: {
    ...
    password: {
      title: "密码保护",
      description:
        "用密码保护你的Cognivis实例。如果你忘记了密码，那么没有恢复方法，所以请确保保存这个密码。",
      "password-label": "实例密码",
    },
  },
  home: {
  ...
  telegram: {
    title: "Telegram 机器人",
    description:
      "将您的 Cognivis 实例与 Telegram 连接起来，这样您就可以从任何设备与您的工作空间进行聊天。",
    setup: {
      step1: {
