...
const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      ...
      description:
        "Cognivis ist mit vielen LLM-Anbietern kompatibel. Der ausgewählte Dienst wird für die Chats verwendet.",
    },
    userSetup: {
    ...
    survey: {
      title: "Willkommen bei Cognivis",
      description:
        "Helfen Sie uns, Cognivis an Ihre Bedürfnisse anzupassen. (Optional)",
      email: "Wie lautet Ihre E-Mail-Adresse?",
      useCase: "Wofür möchten Sie Cognivis verwenden?",
      useCaseWork: "Beruflich",
      useCasePersonal: "Privat",
      useCaseOther: "Sonstiges",
      comment: "Wie haben Sie von Cognivis erfahren?",
      commentPlaceholder:
  ...
  general: {
    ...
    message: {
      ...
      heading: "Erkläre mir",
      body: "die Vorteile von Cognivis",
    },
    delete: {
  ...
  agent: {
    ...
    settings: {
      ...
      "intelligent-skill-selection": {
        ...
        description:
          "Ermöglichen Sie die uneingeschränkte Nutzung von Werkzeugen und reduzieren Sie die Token-Nutzung pro Anfrage um bis zu 80 % – Cognivis wählt automatisch die passenden Fähigkeiten für jede Anfrage aus.",
        "max-tools": {
          title: "Max Tools",
          description:
  ...
  customization: {
    interface: {
      ...
      description: "Passen Sie die Benutzeroberfläche von Cognivis an.",
    },
    branding: {
      title: "Branding & Whitelabeling",
      description:
        "Individualisieren Sie Ihre Cognivis-Instanz durch eigenes Branding.",
    },
    chat: {
      title: "Chat",
      description: "Passen Sie Ihre Chat-Einstellungen für Cognivis an.",
      auto_submit: {
  ...
  api: {
    title: "API-Schlüssel",
    description:
      "API-Schlüssel ermöglichen es dem Besitzer, programmatisch auf diese Cognivis-Instanz zuzugreifen und sie zu verwalten.",
    ...
    modal: {
      ...
      helper:
        "Nach der Erstellung kann der API-Schlüssel verwendet werden, um programmgesteuert auf diese Cognivis-Instanz zuzugreifen und sie zu konfigurieren.",
      name: {
        label: "Name",
  ...
  llm: {
    title: "LLM-Präferenz",
    description:
      "Dies sind die Anmeldeinformationen und Einstellungen für Ihren bevorzugten LLM-Chat- und Einbettungsanbieter. Es ist wichtig, dass diese Schlüssel aktuell und korrekt sind, sonst wird Cognivis nicht richtig funktionieren.",
  ...
  transcription: {
    ...
    "warn-start":
      "Die Verwendung des lokalen Whisper-Modells auf Maschinen mit begrenztem RAM oder CPU kann Cognivis bei der Verarbeitung von Mediendateien zum Stillstand bringen.",
    "warn-recommend":
  ...
  embedding: {
    ...
    "desc-end":
      "Einbettung ist der Prozess, Text in Vektoren umzuwandeln. Diese Anmeldeinformationen sind erforderlich, um Ihre Dateien und Prompts in ein Format umzuwandeln, das Cognivis zur Verarbeitung verwenden kann.",
    provider: {
  ...
  vector: {
    ...
    description:
      "Dies sind die Anmeldeinformationen und Einstellungen für die Funktionsweise Ihrer Cognivis-Instanz. Es ist wichtig, dass diese Schlüssel aktuell und korrekt sind.",
    provider: {
  ...
  privacy: {
    ...
    description:
      "Dies ist Ihre Konfiguration dafür, wie verbundene Drittanbieter und Cognivis Ihre Daten behandeln.",
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "Diese Dateien werden zum Dokumentenprozessor hochgeladen, der auf dieser Cognivis-Instanz läuft. Diese Dateien werden nicht an Dritte gesendet oder geteilt.",
    },
    pinning: {
  ...
  chat_window: {
    ...
    memories: {
      ...
      modal: {
        ...
        label: "Gedächtnis",
        placeholder:
          "z.B. Benutzername: Joe, Benutzer arbeitet an Cognivis, usw.",
        create: "Erstellen",
        save: "Speichern",
        cancel: "Abbrechen",
      },
    ...
    publish: {
      ...
      generic: {
        unauthenticated: {
          ...
          description:
            "Sie müssen sich vor der Veröffentlichung von Inhalten über den Cognivis Community Hub authentifizieren.",
  ...
  security: {
    ...
    password: {
      ...
      description:
        "Schützen Sie Ihre Cognivis-Instanz mit einem Passwort. Wenn Sie dieses vergessen, gibt es keine Wiederherstellungsmethode, also stellen Sie sicher, dass Sie dieses Passwort speichern.",
