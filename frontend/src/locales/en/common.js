const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      ...
      description:
        "Cognivis can work with many LLM providers. This will be the service which handles chatting.",
    },
    userSetup: {
      title: "User Setup",
    ...
    survey: {
      title: "Welcome to Cognivis",
      description: "Help us make Cognivis built for your needs. Optional.",
      email: "What's your email?",
      useCase: "What will you use Cognivis for?",
      useCaseWork: "For work",
      useCasePersonal: "For personal use",
      useCaseOther: "Other",
      comment: "How did you hear about Cognivis?",
      commentPlaceholder:
  ...
  agent: {
    ...
    settings: {
      ...
      "intelligent-skill-selection": {
        ...
        "beta-badge": "Beta",
        description:
          "Enable unlimited tools and cut token usage by up to 80% per query — Cognivis automatically selects the right skills for every prompt.",
        "max-tools": {
          title: "Max Tools",
          description:
  ...
  customization: {
    interface: {
      ...
      description: "Set your UI preferences for Cognivis.",
    },
    branding: {
      title: "Branding & Whitelabeling",
      description:
        "White-label your Cognivis instance with custom branding.",
    },
    chat: {
      title: "Chat",
      description: "Set your chat preferences for Cognivis.",
      auto_submit: {
    ...
    items: {
      ...
      "display-language": {
        ...
        description:
          "Select the preferred language to render Cognivis's UI in - when translations are available.",
      },
      logo: {
        title: "Brand Logo",
  ...
  api: {
    title: "API Keys",
    description:
      "API keys allow the holder to programmatically access and manage this Cognivis instance.",
    ...
    modal: {
      ...
      helper:
        "Once created the API key can be used to programmatically access and configure this Cognivis instance.",
      name: {
        label: "Name",
  ...
  llm: {
    title: "LLM Preference",
    description:
      "These are the credentials and settings for your preferred LLM chat & embedding provider. It is important that these keys are current and correct, or else Cognivis will not function properly.",
  ...
  transcription: {
    ...
    "warn-start":
      "Using the local whisper model on machines with limited RAM or CPU can stall Cognivis when processing media files.",
    "warn-recommend":
  ...
  embedding: {
    ...
    "desc-end":
      "Embedding is the process of turning text into vectors. These credentials are required to turn your files and prompts into a format which Cognivis can use to process.",
    provider: {
  ...
  vector: {
    ...
    description:
      "These are the credentials and settings for how your Cognivis instance will function. It's important these keys are current and correct.",
    provider: {
  ...
  telegram: {
    title: "Telegram Bot",
    description:
      "Connect your Cognivis instance to Telegram so you can chat with your workspaces from any device.",
    setup: {
      step1: {
  ...
  security: {
    ...
    password: {
      ...
      description:
        "Protect your Cognivis instance with a password. If you forget this there is no recovery method so ensure you save this password.",
  ...
  privacy: {
    ...
    description:
      "This is your configuration for how connected third party providers and Cognivis handle your data.",
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "These files will be uploaded to the document processor running on this Cognivis instance. These files are not sent or shared with a third party.",
    },
    pinning: {
      what_pinning: "What is document pinning?",
      pin_explained_block1:
        "When you <b>pin</b> a document in Cognivis we will inject the entire content of the document into your prompt window for your LLM to fully comprehend.",
      pin_explained_block2:
        "This works best with <b>large-context models</b> or small files that are critical to its knowledge-base.",
      pin_explained_block3:
        "If you are not getting the answers you desire from Cognivis by default then pinning is a great way to get higher quality answers in a click.",
      accept: "Okay, got it",
    },
    watching: {
      what_watching: "What does watching a document do?",
      watch_explained_block1:
        "When you <b>watch</b> a document in Cognivis we will <i>automatically</i> sync your document content from it's original source on regular intervals. This will automatically update the content in every workspace where this file is managed.",
  ...
  chat_window: {
    ...
    memories: {
      ...
      modal: {
        ...
        label: "Memory",
        placeholder: "e.g. User's name is Joe, User works on Cognivis, etc.",
        create: "Create",
        save: "Save",
        cancel: "Cancel",
      },
    ...
    publish: {
      ...
      generic: {
        unauthenticated: {
          ...
          description:
            "You need to authenticate with the Cognivis Community Hub before publishing items.",
