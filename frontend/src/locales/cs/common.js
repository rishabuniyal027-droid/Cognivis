...
const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      ...
      description:
        "Cognivis může pracovat s mnoha poskytovateli LLM. Toto bude služba, která bude zpracovávat chatování.",
    },
    userSetup: {
    ...
    survey: {
      title: "Vítejte v Cognivis",
      description:
        "Pomozte nám vybudovat Cognivis pro vaše potřeby. Volitelné.",
      email: "Jaký je váš e-mail?",
      useCase: "K čemu budete Cognivis používat?",
      useCaseWork: "Pro práci",
      useCasePersonal: "Pro osobní použití",
      useCaseOther: "Jiné",
      comment: "Jak jste se o Cognivis dozvěděli?",
      commentPlaceholder:
  ...
  agent: {
    ...
    settings: {
      ...
      "intelligent-skill-selection": {
        ...
        "beta-badge": "Beta",
        description:
          "Umožněte použití libovolného počtu nástrojů a snížit využití tokenů až o 80 % pro každou dotaz — Cognivis automaticky vybírá vhodné dovednosti pro každou žádost.",
        "max-tools": {
          title: "Nástroje Max",
          description:
  ...
  customization: {
    interface: {
      ...
      description: "Nastavte své předvolby rozhraní pro Cognivis.",
    },
    branding: {
      title: "Značení a bílé označení",
      description:
        "Bílé označení instance Cognivis pomocí vlastního značení.",
    },
    chat: {
      title: "Chat",
      description: "Nastavte své předvolby chatu pro Cognivis.",
      auto_submit: {
    ...
    items: {
      ...
      "display-language": {
        ...
        description:
          "Vyberte preferovaný jazyk pro vykreslení rozhraní Cognivis - pokud jsou k dispozici překlady.",
      },
      logo: {
        title: "Logo značky",
        description:
  ...
  api: {
    title: "API klíče",
    description:
      "API klíče umožňují držiteli programově přistupovat a spravovat tuto instanci Cognivis.",
    ...
    modal: {
      ...
      helper:
        "Po vytvoření lze API klíč použít pro programový přístup k této instanci Cognivis a její správu.",
      name: {
        label: "Název",
  ...
  llm: {
    title: "Preferovaný LLM",
    description:
      "Toto jsou přihlašovací údaje a nastavení pro vašeho preferovaného poskytovatele chatu a embeddingu LLM. Je důležité, aby tyto klíče byly aktuální a správné, jinak Cognivis nebude fungovat správně.",
  ...
  transcription: {
    ...
    "warn-start":
      "Použití místního modelu whisper na strojích s omezenou RAM nebo CPU může zastavit Cognivis při zpracování mediálních souborů.",
  ...
  embedding: {
    ...
    "desc-end":
      "Embedding je proces převodu textu na vektory. Tyto přihlašovací údaje jsou nutné k převodu vašich souborů a výzev do formátu, který Cognivis může použít ke zpracování.",
    provider: {
  ...
  vector: {
    ...
    description:
      "Toto jsou přihlašovací údaje a nastavení, jak bude vaše instance Cognivis fungovat. Je důležité, aby tyto klíče byly aktuální a správné.",
    provider: {
  ...
  security: {
    ...
    password: {
      ...
      description:
        "Chraňte svou instanci Cognivis heslem. Pokud zapomenete, neexistuje způsob obnovení, proto se ujistěte, že heslo uložíte.",
  ...
  privacy: {
    ...
    description:
      "Toto je vaše konfigurace, jak připojené třetí strany a Cognivis zpracovávají vaše data.",
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "Tyto soubory budou nahrány na procesor dokumentů běžící na této instanci Cognivis. Tyto soubory nejsou odesílány nebo sdíleny s třetí stranou.",
    },
    pinning: {
      what_pinning: "Co je připínání dokumentů?",
      pin_explained_block1:
        "Když <b>připnete</b> dokument v Cognivis, vložíme celý obsah dokumentu do vašeho okna výzvy, aby ho LLM plně pochopil.",
      ...
      pin_explained_block3:
        "Pokud nedostáváte odpovědi, které si přejete od Cognivis ve výchozím nastavení, pak připínání je skvělý způsob získání kvalitnějších odpovědí jedním kliknutím.",
      accept: "OK, rozumím",
    },
    watching: {
      what_watching: "Co dělá sledování dokumentu?",
      watch_explained_block1:
        "Když <b>sledujete</b> dokument v Cognivis, <i>automaticky</i> synchronizujeme obsah dokumentu z jeho původního zdroje v pravidelných intervalech. Tím se automaticky aktualizuje obsah v každém pracovním prostoru, kde je tento soubor spravován.",
  ...
  chat_window: {
    ...
    memories: {
      ...
      modal: {
        ...
        label: "Paměť",
        placeholder:
          "např. Jméno uživatele je Joe, uživatel pracuje na Cognivis, atd.",
        create: "Vytvořit",
        save: "Uložit",
        cancel: "Zrušit",
      },
    ...
    publish: {
      ...
      generic: {
        unauthenticated: {
          ...
          description:
            "Musíte se ověřit pomocí komunitního centra Cognivis před publikováním položek.",
  ...
  telegram: {
    ...
    description:
      "Propojte svůj instance Cognivis s aplikací Telegram, abyste mohli komunikovat se svými pracovními prostory odkudkoli.",
    setup: {
      step1: {
