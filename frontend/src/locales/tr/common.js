...
const TRANSLATIONS = {
  onboarding: {
    survey: {
      ...
      useCase: "Cognivis'yi ne için kullanacaksınız?",
      useCaseWork: "İş için",
      useCasePersonal: "Kişisel kullanım için",
      useCaseOther: "Diğer",
      comment: "Cognivis'yi nasıl duydunuz?",
      commentPlaceholder:
        "Reddit, Twitter, GitHub, YouTube vb. - Bizi nasıl buldunuz?",
      skip: "Anketi Atla",
      thankYou: "Geri bildiriminiz için teşekkür ederiz!",
      title: "Cognivis'ye Hoş Geldiniz",
      description:
        "Cognivis'yi ihtiyaçlarınıza göre oluşturmamıza yardımcı olun. İsteğe bağlı.",
    },
    home: {
      getStarted: "Başla",
    ...
    llm: {
      title: "LLM Tercihi",
      description:
        "Cognivis birçok LLM sağlayıcısıyla çalışabilir. Bu, sohbeti yöneten hizmet olacaktır.",
    },
    userSetup: {
  ...
  agent: {
    ...
    settings: {
      ...
      "intelligent-skill-selection": {
        ...
        "beta-badge": "Beta",
        description:
          'Her sorgu için sınırsız araç kullanımı ve "cut token" kullanımını %80\'e kadar azaltma imkanı sunar — Cognivis, her talep için doğru becerileri otomatik olarak seçer.',
        "max-tools": {
          title: "Max Araçları",
          description:
  ...
  api: {
    ...
    description:
      "API anahtarları, bu Cognivis örneğine programatik olarak erişmeye ve yönetmeye olanak tanır.",
    ...
    modal: {
      ...
      helper:
        "Oluşturulduktan sonra API anahtarı, bu Cognivis örneğine programatik olarak erişmek ve onu yapılandırmak için kullanılabilir.",
      name: {
        label: "Ad",
  ...
  llm: {
    title: "LLM Tercihi",
    description:
      "Bu, tercih ettiğiniz LLM sohbet ve gömme sağlayıcısının kimlik bilgileri ile ayarlarıdır. Bu anahtarların güncel ve doğru olması önemlidir; aksi takdirde Cognivis doğru çalışmayacaktır.",
  ...
  transcription: {
    ...
    "warn-start":
      "Sınırlı RAM veya CPU'ya sahip makinelerde yerel Whisper modelini kullanmak, medya dosyalarını işlerken Cognivis'nin duraksamasına neden olabilir.",
    "warn-recommend":
  ...
  embedding: {
    ...
    "desc-end":
      "Gömme, metni vektörlere dönüştürme sürecidir. Dosyalarınızın ve komutlarınızın işlenebilmesi için Cognivis, bu kimlik bilgilerine ihtiyaç duyar.",
    provider: {
  ...
  vector: {
    ...
    description:
      "Cognivis örneğinizin nasıl çalışacağını belirleyen kimlik bilgileri ve ayarları burada bulunur. Bu anahtarların güncel ve doğru olması önemlidir.",
    provider: {
  ...
  privacy: {
    ...
    description:
      "Bağlantılı üçüncü taraf sağlayıcılarla ve Cognivis ile verilerinizin nasıl ele alındığını burada yapılandırabilirsiniz.",
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "Bu dosyalar, bu Cognivis örneğinde çalışan belge işleyiciye yüklenecektir. Bu dosyalar üçüncü taraflarla paylaşılmaz.",
    },
    pinning: {
      what_pinning: "Belge sabitleme nedir?",
      pin_explained_block1:
        "Cognivis'de bir belgeyi <b>sabitlediğinizde</b>, belgenin tüm içeriğini LLM'nin tam olarak anlaması için prompt pencerenize enjekte ederiz.",
      pin_explained_block2:
        "Bu, <b>büyük bağlam modelleri</b> veya bilgi tabanı için kritik olan küçük dosyalarla en iyi şekilde çalışır.",
      pin_explained_block3:
        "Cognivis'den varsayılan olarak istediğiniz yanıtları alamıyorsanız, sabitleme tek tıklamayla daha yüksek kaliteli yanıtlar almanın harika bir yoludur.",
      accept: "Tamam, anladım",
    },
    watching: {
      what_watching: "Bir belgeyi izlemek ne yapar?",
      watch_explained_block1:
        "Cognivis'de bir belgeyi <b>izlediğinizde</b>, belge içeriğinizi orijinal kaynağından düzenli aralıklarla <i>otomatik olarak</i> senkronize ederiz. Bu, dosyanın yönetildiği her çalışma alanında içeriği otomatik olarak günceller.",
  ...
  chat_window: {
    ...
    memories: {
      ...
      modal: {
        ...
        label: "Bellek",
        placeholder:
          "Örneğin, kullanıcının adı Joe, kullanıcı Cognivis üzerinde çalışıyor, vb.",
        create: "Yarat",
        save: "Kaydet",
        cancel: "İptal et",
      },
  ...
  customization: {
    interface: {
      ...
      description: "Cognivis için arayüz tercihlerinizi ayarlayın.",
    },
    branding: {
      title: "Marka & Beyaz Etiketleme",
      description:
        "Cognivis örneğinizi özel markalamayla beyaz etiketleyin.",
    },
    chat: {
      title: "Sohbet",
      description: "Cognivis için sohbet tercihlerinizi ayarlayın.",
      auto_submit: {
    ...
    items: {
      ...
      "display-language": {
        ...
        description:
          "Cognivis'nin kullanıcı arayüzünü görüntülemek için tercih edilen dili seçin - çeviriler mevcut olduğunda.",
      },
      logo: {
        title: "Marka Logosu",
    ...
    publish: {
      ...
      generic: {
        unauthenticated: {
          ...
          description:
            "Öğeleri yayınlamadan önce Cognivis Topluluk Hub'ına kimlik doğrulaması yapmanız gerekir.",
  ...
  security: {
    ...
    password: {
      ...
      description:
        "Cognivis örneğinizi bir şifre ile koruyun. Bu şifreyi unutmanız hâlinde kurtarma yöntemi yoktur, bu yüzden mutlaka güvende saklayın.",
  ...
  telegram: {
    ...
    description:
      "Cognivis örneğinizi Telegram ile bağlantılandırarak, herhangi bir cihazdan çalışma alanlarınızla sohbet edebilmelisiniz.",
    setup: {
      step1: {
