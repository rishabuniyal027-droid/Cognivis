...
import Cognivis from "./media/logo/anything-llm.png";
import CognivisDark from "./media/logo/anything-llm-dark.png";
  ...
  async function fetchInstanceLogo() {
    ...
    try {
      ...
      if (logoURL) {
        ...
        isLightMode() ? setLogo(CognivisDark) : setLogo(Cognivis);
