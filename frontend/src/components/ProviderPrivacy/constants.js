...
const VECTOR_DB_PROVIDER_PRIVACY_MAP = {
  ...
  lancedb: {
    name: "LanceDB",
    description: [
      "Your vectors and document text are stored privately on this instance of Cognivis.",
    ],
    logo: LanceDbLogo,
  },
};
...
const EMBEDDING_ENGINE_PROVIDER_PRIVACY_MAP = {
  native: {
    name: "Cognivis Embedder",
    description: [
      "Your document text is embedded privately on this instance of Cognivis.",
    ],
    logo: CognivisIcon,
  },
  openai: {
