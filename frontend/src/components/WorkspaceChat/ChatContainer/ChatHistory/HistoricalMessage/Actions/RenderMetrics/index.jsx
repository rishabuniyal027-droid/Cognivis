...
const SHOW_METRICS_KEY = "Cognivis_show_chat_metrics";
const SHOW_METRICS_EVENT = "Cognivis_show_metrics_change";
...
/**
 * Get the show metrics setting from localStorage `Cognivis_show_chat_metrics` key
 * @returns {boolean}
 */
...
/**
 * Toggle the show metrics setting in localStorage `Cognivis_show_chat_metrics` key
 * @returns {void}
 */
