...
![Cognivis](https://raw.githubusercontent.com/Mintplex-Labs/anything-llm/master/images/wordmark.png)

[Cognivis](https://github.com/Mintplex-Labs/anything-llm)
...
```yaml
image:
  repository: mintplexlabs/Cognivis
  tag: "1.12.1"
...
```
helm install my-Cognivis ./Cognivis -f values-secret.yaml
```
...
| image.repository | string | `"mintplexlabs/Cognivis"` |  |
