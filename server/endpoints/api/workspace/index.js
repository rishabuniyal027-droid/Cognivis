      ...
      content: {
        "application/json": {
          example: {
            ...
            deletes: ["custom-documents/Cognivis.txt-hash.json"]
          }
        }
      }
    }
           ...
           example: {
             ...
             attachments: [
               ...
               },
               {
                 ...
                 mime: "application/Cognivis-document",
       ...
       "application/json": {
         schema: {
           ...
           example: {
              ...
              sources: [{title: "Cognivis.txt", chunk: "This is a context chunk used in the answer of the prompt by the LLM,"}],
              close: true,
           ...
           example: [
            ...
            },
            {
            ...
            },
             {
              ...
              sources: [{title: "Cognivis.txt", chunk: "This is a context chunk used in the answer of the prompt by the LLM. This will only return in the final chunk."}],
              close: true,
              error: "null | text string of the failure mode."
            }
          ]
