 ...
 * as well as build features in Cognivis directly for a specific model or capabilities.
 *
...
/**
 * Returns the user agent for the Cognivis deployment.
 * @returns {string} The user agent.
 */
function getCognivisUserAgent() {
  const version = getDeploymentVersion() || "unknown";
  return `Cognivis/${version}`;
}
