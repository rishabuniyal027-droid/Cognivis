...
// This keeps accidental misconfigurations of Cognivis that leave the collector port open from
...
class CommunicationKey {
  ...
  #generate() {
    ...
    this.log(
      "RSA key pair generated for signed payloads within Cognivis services."
    );
  }
