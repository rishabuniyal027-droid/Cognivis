...
/**
 * Applies Cognivis branding to an Excel workbook.
 * Adds a subtle "Created with Cognivis" text row below the data on each sheet.
...
function applyBranding(workbook) {
  for (const worksheet of workbook.worksheets) {
    ...
    brandingCell.value = "Created with Cognivis";
    brandingCell.font = {
      italic: true,
      size: 9,
      color: { argb: "FF999999" },
